...
export const TOURS: Tour[] = [
  ...
  { slug: "varden-smaatindan", name: "Varden (Småtindan)", region: "Lofoten", lat: 68.23317, lng: 14.38794, summitM: 700, verticalM: 820, duration: "4–6 t", grade: 2, aspect: "Ø", season: "jan–apr", hasGuide: true, teaser: "820 høgdemeter frå Eidet ved Kabelvåg: lysløypa langs Karlsvatnet, over eidet mot Aksla, gjennom skaret rundt Ørntinden, og vestflanken til toppen av øygruppas mest gåtte skitur." },
  ...
  { slug: "tomskjevelen", name: "Tomskjevelen", region: "Helgeland", lat: 66.27901, lng: 12.84655, summitM: 922, verticalM: 950, duration: "4–6 t", grade: 2, aspect: "S", season: "jan–apr", hasGuide: true, teaser: "950 høgdemeter frå åkeren ved Forsland på Tomma: stien til Forslandsvatnet, rundt tjernet på land, og den nordvestgåande ryggen heilt til topps på øyfjellet Fri Flyt kallar Helgelands finaste." },
