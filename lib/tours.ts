...
export const TOURS: Tour[] = [
  ...
  { slug: "hamperokken", name: "Hamperokken", region: "Troms", lat: 69.5621, lng: 19.35872, summitM: 1397, verticalM: 1400, duration: "5–7 t", grade: 4, aspect: "NV", season: "feb–mai", teaser: "1400 høydemeter fra Fv91, men skiene settes igjen på Middagsaksla 1076 moh – siste 1,4 km er eksponert rygg til fots." },
  { slug: "kavringtinden", name: "Kavringtinden", region: "Lyngen", lat: 69.54704, lng: 20.12428, summitM: 1289, verticalM: 1240, duration: "5–7 t", grade: 3, aspect: "N", season: "mar–mai", hasGuide: true, teaser: "Indre Lyngen-perle med nordvendt snø som holder seg langt ut i mai." },
  ...
  { slug: "keipen", name: "Keipen", region: "Senja", lat: 69.4953, lng: 17.72324, summitM: 938, verticalM: 840, duration: "3–5 t", grade: 3, aspect: "S", season: "jan–mai", teaser: "837 høydemeter fra Medfjordbotnvatnan gjennom skåla sør for toppen, jevnt 33 grader opp mot toppryggen." },
  { slug: "breitinden", name: "Breitinden", region: "Senja", lat: 69.45168, lng: 17.65623, summitM: 1007, verticalM: 1020, duration: "4–6 t", grade: 4, aspect: "SV", season: "jan–apr", teaser: "1020 høydemeter fra Svarthola via Svartholvatnet og Breitindvatnet; de siste 140 er klyving på sørvestryggen." },
  ...
  { slug: "geitgaljen", name: "Geitgaljen", region: "Lofoten", lat: 68.34434, lng: 14.81302, summitM: 1085, verticalM: 1070, duration: "4–6 t", grade: 4, aspect: "NV", season: "feb–apr", teaser: "1065 høydemeter fra Liland opp Lilandsdalen; renna fra 250 til 360 moh er 35 grader, og toppen krever stegjern." },
  ...
  { slug: "kolastinden", name: "Kolåstinden", region: "Sunnmøre", lat: 62.25886, lng: 6.31102, summitM: 1432, verticalM: 1080, duration: "5–7 t", grade: 3, aspect: "N", season: "feb–mai", hasGuide: true, teaser: "Alpin klassiker fra Standaldalen med velkjent renne og storslått finish." },
  { slug: "saudehornet", name: "Saudehornet", region: "Sunnmøre", lat: 62.23578, lng: 6.14246, summitM: 1303, verticalM: 1160, duration: "4–6 t", grade: 3, aspect: "SV", season: "jan–mai", teaser: "1154 høgdemeter frå vassverket i Ørsta, og sørryggen held 33–39° dei siste 170." },
  { slug: "slogen", name: "Slogen", region: "Sunnmøre", lat: 62.20818, lng: 6.67306, summitM: 1564, verticalM: 1480, duration: "6–8 t", grade: 4, aspect: "V", season: "mar–mai", hasGuide: true, teaser: "Sunnmørsalpenes dronning — en alvorlig tur for erfarne, i riktig vindu." },
  { slug: "jakta", name: "Jakta", region: "Sunnmøre", lat: 62.1711, lng: 6.61671, summitM: 1589, verticalM: 1560, duration: "6–8 t", grade: 3, aspect: "SØ", season: "feb–mai", teaser: "1560 høgdemeter frå Norang: slak stigning inn Konedalen, så ei 33-graders side opp på den smale toppryggen." },
  { slug: "skarasalen", name: "Skårasalen", region: "Sunnmøre", lat: 62.16566, lng: 6.48583, summitM: 1542, verticalM: 1440, duration: "6–8 t", grade: 3, aspect: "V", season: "jan–mai", teaser: "1438 høgdemeter frå bommen på Kvistadvegen, med det brattaste opp mot skaret på 1074 moh." },
  { slug: "rondslottet", name: "Rondslottet", region: "Rondane", lat: 61.9149, lng: 9.8512, summitM: 2178, verticalM: 1240, duration: "6–8 t", grade: 2, aspect: "S", season: "mar–mai", hasGuide: true, teaser: "Rondanes høyeste: rolig høyfjellsterreng og stabil vårsesong." },
  { slug: "storronden", name: "Storronden", region: "Rondane", lat: 61.8917, lng: 9.86198, summitM: 2139, verticalM: 1140, duration: "6–8 t", grade: 2, aspect: "SV", season: "mars–mai", teaser: "1140 høydemeter fra Spranget: seks kilometer innmarsj til Rondvassbu, så 2,6 km jevn vestrygg fra stidelet på 1440 moh." },
  ...
  { slug: "glittertinden", name: "Glittertinden", region: "Jotunheimen", lat: 61.65138, lng: 8.5575, summitM: 2451, verticalM: 1180, duration: "7–9 t", grade: 3, aspect: "SØ", season: "juni–juli", teaser: "12,6 km og 1180 høydemeter fra Veodalen: 7 km flat innmarsj til Glitterheim, så jevn stigning øst for Glitterbrean." },
  ...
  { slug: "besshoe", name: "Besshø", region: "Jotunheimen", lat: 61.51791, lng: 8.68712, summitM: 2257, verticalM: 1300, duration: "6–8 t", grade: 3, aspect: "Ø", season: "mars–mai", teaser: "1296 høydemeter fra Bessheim: seks kilometer langs Bessvatnet før Grotådalen, og til slutt den slake austryggen over Brue." },
  ...
  { slug: "rasletinden", name: "Rasletinden", region: "Jotunheimen", lat: 61.39514, lng: 8.69944, summitM: 2104, verticalM: 750, duration: "4–6 t", grade: 2, aspect: "Ø", season: "apr–mai", teaser: "750 høydemeter og 6 km fra Valdresflye: flatt de første 1,2 km, så en kneik til 1530 moh og slak rygg østfra mot toppen." },
  ...
  { slug: "skogshorn", name: "Skogshorn", region: "Hemsedal", lat: 60.88148, lng: 8.69482, summitM: 1729, verticalM: 840, duration: "3–5 t", grade: 2, aspect: "Ø", season: "feb–mai", teaser: "836 høgdemeter frå Trefta opp den breie austryggen; brattaste måling er 28,5 grader." },
  ...
  { slug: "lonahorgi", name: "Lønahorgi", region: "Voss", lat: 60.69383, lng: 6.41489, summitM: 1412, verticalM: 1300, duration: "6–8 t", grade: 2, aspect: "NØ", season: "feb–april", teaser: "1300 høgdemeter frå Høyland via Bergsstølen og Breiming, med dei siste 107 opp nordryggen frå punkt 1305." },
  { slug: "folarskardnuten", name: "Folarskardnuten", region: "Hallingdal", lat: 60.61336, lng: 7.79146, summitM: 1927, verticalM: 950, duration: "6–8 t", grade: 3, aspect: "S", season: "mars–mai", teaser: "Nær 12 km inn frå Haugastøl og 950 høgdemeter, med eit kort 37-graders trinn opp frå Folarskardet." },
  ...
  { slug: "vesoldo", name: "Vesoldo", region: "Hardanger", lat: 60.31237, lng: 6.09197, summitM: 1046, verticalM: 840, duration: "3–5 t", grade: 2, aspect: "SV", season: "feb–apr", teaser: "834 høgdemeter frå Byrkjenes, skog opp til Fadnastølen og open sørvestrygg over; nord- og vestsida av toppen fell 48–55°." },
