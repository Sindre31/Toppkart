...
export const TOUR_TEASER_EN: Record<string, string> = {
  ...
  storronden:
    "1110 m of climbing from Spranget: six kilometres of approach to Rondvassbu, then 2.6 km of steady west ridge from the 1440 m junction.",
  skogshorn:
  ...
  strandtinden:
    "1140 m from the E10 at sea level up through Heggedalen and the west ridge — the great classic of the Harstad area, and the peak most people there ski.",
  raskarfjellet:
  ...
  "varden-smaatindan":
    "760 metres of ascent from Eidet by Kabelvåg: the lit trail along Karlsvatnet, over the neck towards Ørntindaksla and through the notch west of it, and the east flank to the top of the archipelago's most skied tour.",
  midtitinden:
  ...
  middagstinden:
    "1290 metres of ascent from Herdslan in Innfjorden: the road along Berillvatnet, the stream gully to the col at Tindevatnet — and an often wind-scoured ridge, skis on the pack, before the west-facing summit flank.",
  skarlitinden:
  ...
  skjomtinden:
    "1390 metres of ascent from Nervatnet in Håkvikdalen to the Sleeping Queen: the hollow around Litletind, the ridge toward Dronninga, the traverse on the west sides — and the snow gully onto the crest. Ice axe and crampons in the pack.",
  litletind:
  ...
  reinspalen:
    "1370 metres of ascent from Våtvoll to Kvæfjord's highest — Kobberyggen and Geitryggen with plenty of up and down, and an exposed ridge traverse with walls on both sides at the end.",
  snotindan:
  ...
  kongsviktinden:
    "1050 metres of ascent from the Y-junction before the barrier: the winter-closed road into Kongsvikdalen, the summer trail at Sætran and the south contour across the plateau — the gentlest ground toward the south-east summit, with axe and crampons in the pack.",
  jakobstinden:
    "1020 metres of ascent from the same Y-junction as Kongsviktinden: four kilometres into Kongsvikdalen, the moors at Sætran, the broad ramp — stay south of the cornice — and the wide plateau to the summit with the pinnacle.",
  taraldsviktinden:
  ...
  "snotinden-tjeldsund":
    "980 metres of ascent from Dalelva's outlet in Fiskefjorden: the tractor road up Norddalen, the long Marsslottfjellet — and the ridge south-west to the summit, with only three slopes of about 25 degrees in the whole descent.",
  fiskefjordtindan:
    "1040 metres of ascent from Kanstadbotn: the summer trail, the ridge between the Kobbedal lakes — and the exposed east ridge to finish, with axe and crampons in the pack and an east face measuring 67 degrees at its steepest.",
  nonstinden:
    "980 metres of ascent from the Gullesfjordbotn roundabout: the ridge north on the west side of the fjord head, the steep gully to the plateau — and the traverse to a summit without one gentle side: four steep descents, with axe and crampons in the pack.",
  tverrfjellet:
  ...
  skartinden:
    "1190 metres of ascent from Vang: the river valley to Ytterholla, the col between Vasskartinden and Skartinden — and the flat east to the summit, with 60-degree cliffs to steer clear of on the descent.",
  krakrotinden:
  ...
  helligtinden:
    "950 metres of ascent from Breivikbotn: the cabin field at Krokelva, Finnvatnet — and the north-east ridge of Litletinden to Helligtinden, with even 10–20 degree skiing home.",
  siriskolten:
  ...
  lakselvtindan:
    "820 metres of ascent from the Møysalen car park on the E10: the north shore of Storvatnet, up between Tverrelva and Lakselva, past spot height 258 — and the ridge east of Lakselva to the top, the gentlest summit of the round.",
  forkledalstindan:
    "980 metres of ascent from the E10 at Litlvatnet: the north side of spot height 462 and the mountainside up to the 700 m top where the source's ski tour turns — and the traverse on over the fore-summit, with the east side as the way round the hard climbing.",
  forselvtinden:
    "1180 metres of ascent and 8.3 km from the Lofast, over the summit of another tour in the catalogue: up Lakselvtindan first, west to due north of spot height 790 — and the south ridge at the end, with 296 metres given back along the way.",
  kvasstinden:
  ...
  "rundfjellet-harstad":
    "770 metres of ascent and nearly seven kilometres from the DNT hut at Bjørnhaugen: the west shore of Storvatnet, the stream valley north of spot height 339 with avalanche terrain on both sides — and the north-east ridge to the top through cruising country.",
  heia:
    "470 metres of ascent from the football pitch by Krafthallen up the old ski hill: the bog, the open field and Maistua at 321 — and the ridge above the treeline. Harstad's after-work tour, with lights on the hill on weekday evenings.",
  nattmalsfjellet:
    "480 metres of ascent from the Kilkam sports ground: the ski track past the kindergarten, off it southward on the ridge — and the gully for the last hundred metres. It looks easy, but avalanches have run here.",
  hinnstein:
...
export const GUIDE_EN: Record<string, GuideTextEn> = {
  ...
  "store-skalltinden": {
    ...
    descent: [
      ...
      "The other route comes from the back of the mountain: Bjørnskardalen from Bjørnskar, 966 metres of ascent over 6.13 km, up to and across Bjørnskarvatnan — Nedre Bjørnskarvatnet at 220 m and the big lake at 250 — and through the col west of point 621, then up the broad ridge formation that crosses an unnamed tarn at 480. The source calls it «a longer and more demanding choice with an alpine flavour» and expects skis on the pack from the col, with crampons judged by conditions. The steepest step measures 32.1 degrees between 701 and 726 m against the normal route's 27.0. The lakes are unregulated — DTM1 reads them as Innsjø at 250 — and it is the source itself that sends you across the ice.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  kjolen: {
    ...
    descent: [
      ...
      "Fri Flyt gives four starting points for Kjølen, and the card now carries three of them. From the Kvaløysletta care home it is 805 metres of ascent over 6.76 km up through the housing estate to the little ski lift, over Slaktarhaugen at 220 m and Finnlandsfjellet at 494, past Litje-Kjølen at 652 — the gentlest of the three, its steepest step 23.1 degrees between 130 and 149 m. From Slettaelva it is 813 metres over 6.29 km along the works road up Svarthammardalen, 376 m, and west of Amundvatnet. That line has a step of 34.7 degrees between 350 and 371 m — well past the «steepest point: under 27 degrees» the source publishes for the mountain, and which the normal route from Finnvikdalen does stay inside.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  fastdalstinden: {
    intro:
      "1271 metres of ascent and 7.21 km from the road end at Varto — a Lyngen classic with a long approach and a reservoir in the middle of the tour. Fri Flyt rates the normal route KAST 2 with a steepest point of 25–30 degrees, and the measured line is kinder than the reputation: steepest 100-metre band 19.5 degrees between 200 and 300 metres, steepest sustained stretch 25.5. The card's grade 3 is the scale, not the steepness: this is a 6–8 hour tour where the surrounding terrain — cornices, runout zones and a south side with fatal accidents in its history — is a different class from the track.",
    ascent: [
    ...
    elevationProfile: {
      ...
      caption: "1271 metres of ascent and 7.21 km from Varto — a works road, a reservoir rounded on land, and the ridge straight at the 1275-metre summit.",
    },
  },
  tromsdalstinden: {
    intro:
  ...
  fagerfjellet: {
    ...
    descent: [
      ...
      "The other documented route goes into Henrikskaret from the mouth of Fagerelva: 929 metres of ascent over 3.09 km, against the normal route's 947 over 4.30 — the same mountain in two thirds of the distance. The col is in the place-name register and reads 596 m where the line crosses it. Fri Flyt rates the route KAST 3 – Complex against the normal route's KAST 1, and writes of sections at 30–35 degrees between 660 and 740 m; the steepest step on the line measures 30.0 degrees between 340 and 360.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  breitinden: {
    ...
    elevationProfile: {
      ...
      endLabel: "1007 m",
      distanceLabel: "4.2 km",
      caption: "1031 metres of climbing and 4.22 km from Svarthola; the skis stay at the shoulder at 763 m, 244 metres below the summit.",
    },
  },
  skolpan: {
    intro:
  ...
  nona: {
    ...
    ascent: [
      ...
      "Through upper Dalsdalen at 280 and into the gully at 453 m. The source gives the gully 30–45 degrees sustained down to lake 428; on the model's line the steepest single step, 38.4 degrees, sits between 587 and 612 m, and the band from 700 to 800 averages 22.7.",
    ...
    elevationProfile: {
      ...
      caption: "1024 metres of ascent over 5.42 km from Dale: the ski track into Dalsdalen to the treeline at 287, the gully from 453 to 843 m — and the steepest single step, 38.4 degrees between 587 and 612 m, in the middle of the gully.",
    },
  },
  trolltinden: {
    intro:
  ...
  arbostadtinden: {
    intro:
      "1171 metres of ascent in 3.98 km from the fv. 7804 to Årbostadtinden — and a single metre given back on the whole line. The slanting couloir to the top is the landmark here, the one many have skied both early and late in the season, and Fri Flyt holds it «mostly between 30 and 40 degrees». KAST 3 – Complex with ice axe and crampons: grade 4.",
    ascent: [
      "From the lay-by on the fv. 7804 where Storelva reaches the sea — 9 m — the line follows the tractor road winding south from the old school: 52 m where the corridor stands in it. The whole route is mapped as a path in OpenStreetMap, from the road to 40 metres from the cairn, and the terrain model along it gives exactly the 1170 metres of ascent the source states.",
      "On upward on the right-hand — western — side of Storelva: 327 m, and the forest lets go at 386 after 1.12 km. Past the treeline at 593 and up onto the flat by the cabin, 689 m, where the mountain finally shows itself. The band from 600 to 700 is the gentlest on the whole line at 8.4 degrees over 674 metres of ground — that is the flat, and that is where you see what is left.",
      "Then the couloir: 978 m where the corridor is anchored, and the band from 900 to 1000 is the steepest on average at 23.5 degrees over 244 metres of ground. The steepest single step, 29.0 degrees, sits between 901 and 924 m — inside the couloir. The cairn is 1179, and the view runs to Senja and Dyrøy.",
    ],
    descent: [
    ...
    avalanche: [
      {
        title: "The couloir",
        body: "The couloir is the tour, and it is also what makes it KAST 3 – Complex. It holds 30–40 degrees most of the way, it collects whatever comes from above, and it offers no way off to the side: if it goes, it goes where you are standing. The snow has to be stable, and ice axe and crampons are on the source's list for the same reason.",
      },
      {
        title: "The rest of the mountain",
        body: "Only the south-west is mild: 22.1 degrees on average with 29.6 as its steepest window, and west 30.7 with 37.1 — the source's large west-facing flank at the top of the mountain. North and north-east measure 49.2 and 50.3 on average with windows of 66.8 and 74.7, and east 62.4 only 20 to 80 metres out. There is one way up and down from here.",
      },
      {
        title: "Before you go",
        body: "Årbostadtinden sits in the Sør-Troms forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The February–April season is Fri Flyt's, but the couloir holds spring snow long after that. Transceiver, probe and shovel — and ice axe and crampons. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "9 m",
      endLabel: "1179 m",
      distanceLabel: "4.0 km",
      caption: "1171 metres of ascent in 3.98 km from Årbostad: the tractor road from the old school, west of Storelva to the flat by the cabin — and the slanting couloir to the cairn at 1179.",
    },
  },
  klaptinden: {
    intro:
  ...
  skartinden: {
    intro:
      "1193 metres of ascent over 3.92 km from Vang to Skartinden at 1149 — the same turnaround as Langlitinden, the opposite direction: up the river valley to Ytterholla, the col between Vasskartinden and Skartinden, and the ridge or the broad flat east to the summit. KAST 3 – Complex with ice axe and crampons; the descent is 30–40 degrees at the top with 60-degree cliffs around Ytterholla. Grade 4.",
    ascent: [
      ...
      "Ytterholla — the hollow at 497 — and up it if the snow allows, up towards the col between Vasskartinden and Skartinden — its floor is at 795, the line crosses the shoulder at 867 without dropping into it. The band from 800 to 900 measures 9.4 degrees across the flat behind the col: half a kilometre of breathing room before the final push.",
      "The ridge or the flat east from 844: the band from 1000 to 1100 is the steepest on average at 24.8 degrees, and the steepest single step, 38.1 degrees between 869 and 895 m, sits where the flat rears towards the summit section. The cairn stands at 1149.",
    ],
    descent: [
      ...
      "The line gives back 52 of the 1193 metres it wins — the col and the flat are crossed both ways. West, where the route lies, is the gentlest probe at 30.8 on average, and the steep window (35.0) comes only 330–390 m out from the cairn.",
    ],
    avalanche: [
      {
        title: "Ytterholla",
    ...
    elevationProfile: {
      ...
      caption: "1193 metres of ascent over 3.92 km from Vang: the river valley to Ytterholla at 497, over the col — the line at 867, the floor at 795 — and the flat east to the cairn at 1149, with the steepest single step, 38.1 degrees, between 869 and 895 m.",
    },
  },
  langlitinden: {
    intro:
    ...
    descent: [
      ...
      "The other route comes in from Vasskaret in the south: 1148 metres of ascent over 6.73 km from the end of the tractor road, east towards Mørkevatnet — the register's tarn reads 299 m where the source writes 301, and the line clips 90 metres of ice off its south end — and then straight south up Rytterkløfta. The source is plain about the cost: «there can be a lot of ice on the first part, so crampons and axe come out early and the skis go on the pack», and «make sure the snow is stable when you climb here, because this is avalanche terrain and a terrain trap». Above the gully it eases to 30 to 35 degrees until you are at 900 m; the steepest 30-metre window on the line is the summit pull itself, 37.5 degrees between 1251 and 1276. The normal route from Vang is 1305 metres over 5.53 km with a steepest step of 33.5.",
    ],
    avalanche: [
      {
        title: "The traverse",
  ...
  heia: {
    intro:
      "466 metres of ascent over 2.19 km from the football pitch by Krafthallen to Heia — Harstad's old downhill hill, and the tour the town actually skis. The source notes that there are usually lights on the hill in the evening when there is snow, and that the mountain gives efficient vertical and a hut on the way worth more than a visit. KAST 1 – Simple. Grade 1.",
    ascent: [
      "From the car park by the football pitch — 63 m — the route runs along the left-hand side of the bog on a path through the forest: 113 m where the corridor stands. Then out of the trees and up the open field the summer path follows, 205 m.",
      "Maistua sits halfway, at 321 m. It was a radio link before, was renovated in the autumn of 2018 and needs a DNT key; the source calls the view fantastic and the place a modern retreat without equal. The steepest 100 m band measures a mean 20.2 degrees between 200 and 300 metres, over 263 metres of ground, and the steepest single step on the whole line, 25.0 degrees, sits between 260 and 281 m — just below the hut.",
      "Past the flat by Maistua the route slants up a little to the south, and the forest lets go at 375 m after 1.35 km. Above the treeline you follow the ridge — 481 m where the corridor is anchored — to the cairn at 527. The ridge can be scoured and bare or wind-affected, and the source says most people therefore stop a little north of the top.",
    ],
    descent: [
      "The same way down, but all the way along the open field, over the fence under the power line and through the forest to the football pitch. Many do several laps — the source describes training sessions of three laps in an evening, skins on and off, and 1200 metres of ascent in total. The source gives two more variants: the east side of the summit, where the snow is best, down the old lift line; and a line to the south-east down the cleared summer path in Blåbæråsen to the kindergarten at Høgholtet.",
      "All three are KAST 1 and mostly 20–30 degrees. But the source is just as clear about what lies outside them: there you can «easily seek out 40-degree slopes». The flank sweep finds them — north of the cairn a 40.6 window 170–230 metres out, and north-west 46.0 at 160–220.",
    ],
    avalanche: [
      {
        title: "Forty degrees, one turn away",
        body: "Heia is a KAST 1 mountain with KAST 3 terrain beside it. The source states plainly that outside the three described routes you can easily find 40-degree slopes, and that this should only be done when the snow is stable. The measurement confirms it: 40.6 degrees north of the top and 46.0 to the north-west. The three routes stay at 20–30.",
      },
      {
        title: "The summit ridge",
        body: "The last stretch is often scoured, bare or wind-affected, and the source says most people stop a little north of the top. That is not an avalanche warning but an explanation of why the track ends where it does — and on a clear day the cairn is worth the last few metres on foot.",
      },
      {
        title: "Before you go",
        body: "Heia sits in the Sør-Troms forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The December–April season is Fri Flyt's, and the longest in the round — this is the hill that holds snow when the town does not. Transceiver, probe and shovel, even on an evening lap ten minutes from the car. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "63 m",
      endLabel: "527 m",
      distanceLabel: "2.2 km",
      caption: "466 metres of ascent over 2.19 km from Krafthallen: the bog, the open field and Maistua at 321 — and the ridge above the treeline to the cairn at 527.",
    },
  },
  hinnstein: {
    intro:
      "510 metres of ascent over 2.90 km from Breivikhaugen to Hinnstein — one of the most-used tour areas in Harstad, on a par with Heia, and a mountain with steep sides. The source is short and serious about the most popular of them: «the south-east side attracts the most skiers, but be aware that several have been caught in avalanches there.» KAST 3 – Complex. Grade 3.",
    ascent: [
      "From the small car park at the top of Breivikhaugen — 51 m, and do not block the turning circle — the route follows the forest road the landowners built in 2016: 154 m where the corridor stands in it. Past the shelter at 220.",
      "From there you aim for the slope between Litle Hinnstein and Hinnstein — 457 m — which in the old days was used as a ski jump. Litle Hinnstein is a registered point of its own and measures 502 m; it is the lower of the two.",
      "Then the path up the south-west side of Hinnstein, 531 m where the corridor is anchored, to the cairn at 560. The forest does not let go until 496 m after 2.51 km — almost the whole tour is in trees. The steepest 100 m band measures a mean 13.6 degrees between 400 and 500 metres, over 426 metres of ground, and the steepest single step, 23.7 degrees, sits between 394 and 408.",
    ],
    descent: [
      "The source is honest about the start: the descent from Hinnstein gives little flow at first because of scrub, thin snow and stones, and many leave the skis and walk back down the way they came. After that it is gentle cruising in ground no steeper than 30 degrees.",
      "The front face is another matter. Sørøst 2 holds 35–45 degrees, with the easiest line furthest south on the mountain and straight down to the forest road. The flank sweep places the rest: north-west falls at 50.5 degrees only 10–70 metres from the cairn, north 44.3 at 30–90 and west 42.8 at 20–80. South-west, where the route goes, is the gentle side at 12.6 degrees on average.",
    ],
    avalanche: [
      {
        title: "The south-east side",
        body: "This is the side most people ski, and the source's own sentence about it is that several have been caught in avalanches there. It measures 26.9 degrees on average with a 40.4 window 180–240 metres out, and Sørøst 2 on the front face holds 35–45. None of those numbers is extreme; the history is the point, and it belongs to a hill fifteen minutes from town.",
      },
      {
        title: "The north-west side is cut away",
        body: "The summit has a side that is not a route: north-west falls at 50.5 degrees within the first 70 metres of the cairn, and north and west at 44.3 and 42.8 just as close in. The route comes up the south-west side, which is gentle — but on a summit this small the edge is nearer than it looks.",
      },
      {
        title: "Before you go",
        body: "Hinnstein sits in the Sør-Troms forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The January–April season is Fri Flyt's. Transceiver, probe and shovel. The 2016 forest road is the landowners' gift to walkers — park where you should, and leave the turning circle clear. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "51 m",
      endLabel: "560 m",
      distanceLabel: "2.9 km",
      caption: "510 metres of ascent over 2.90 km from Breivikhaugen: the 2016 forest road, the shelter and the old ski jump — and the south-west side to the cairn at 560.",
    },
  },
  lasselitinden: {
    intro:
  ...
  hemmestadfjellet: {
    ...
    descent: [
      ...
      "The west side is the other route: 668 metres of ascent over 2.44 km from the lay-by at Gammelgårdsbukta, past Skommesvik at 74 m and up through the birch to the T-junction on the power line, 341. The source calls it «a much steeper variant than the north side» where «over 30 degrees is normal»; the line here measures 26.2 degrees in its steepest step between 450 and 470 m and 23.0 in the steepest hundred-metre band between 400 and 500. That it is climbed and not merely skied down stands in the neighbouring mountain's text: the Horntindan route opens «park at Skommesvik, walk up towards Hemmestadfjellet and then the ridge southwards to Horntindan.»",
    ],
    avalanche: [
      {
  ...
  nattmalsfjellet: {
    intro:
      "479 metres of ascent over 2.69 km from the Kilkam sports ground to Nattmålsfjellet — the closest ski hill in Kilbotn, and the one in this round where the source is clearest that appearances lie. «Even though Nattmålsfjellet looks easy, there are several places where avalanches can run, and they have run here.» KAST 2 – Challenging on the normal route; every other ascent on the north side is KAST 3. Grade 3.",
    ascent: [
      "From the large car park by the sports ground — 85 m — you follow the ski track past the kindergarten: 89 m where the corridor stands, almost flat. The band from 0 to 100 m measures a mean 1.7 degrees, over 673 metres of ground.",
      "Then off the track southward where the mountain is closest, on the ridge before Nattmålsfjellvatnet — 237 m. The forest lets go at 284 after 1.68 km. Nearer the treeline you keep to the right-hand — western — side of a small knoll: 279 m where the corridor is anchored.",
      "From there the large open area leads up towards the top. The last hundred metres of ascent go up a gully that is the continuation of the stream running down to the south side of Nattmålsfjellvatnet — 393 m where the corridor stands in it. The steepest 100 m band measures a mean 15.1 degrees between 300 and 400 metres, over 392 metres of ground, and the steepest single step, 22.0 degrees, sits between 422 and 441. The cairn is 546.",
    ],
    descent: [
      "Down the same way. The descent is no steeper than 30 degrees, says the source — but it is surrounded by steeper ground, and you are at times standing in runout zones. That is a different sentence from «gentle», and it is worth reading twice.",
      "The flank sweep shows the same picture: the summit itself is gentle on every bearing — 3.3 degrees on average to the south-east, 5.1 to the south-west, 5.3 to the south — while the steepest windows sit far out, 34.5 degrees 300–360 metres to the north-east and 35.3 at 440–500 to the south-east. Those are the ones you can end up beneath, not the ones you stand on.",
    ],
    avalanche: [
      {
        title: "The runout zones",
        body: "This is the mountain where the terrain trap is not under your skis but above them. The descent stays below 30 degrees and the summit is gentle, but steeper ground surrounds it, and the source says you are at times in runout zones. The measurement finds the steepest sections 300 to 500 metres out on the north-east and south-east sides. Judge what hangs over the track, not only what you are standing on.",
      },
      {
        title: "Nord 2 and the rest of the north side",
        body: "Every ascent on the north side other than Nord 1 is KAST 3, says the source. Nord 2 descends steep gullies and hollows towards the open area above the floodlit trail. On that area lies Okshola, a cave some 300 metres long with a river running through it and an exit usually filled with water — worth a visit, but not a way out.",
      },
      {
        title: "Before you go",
        body: "Nattmålsfjellet sits in the Sør-Troms forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The February–April season is Fri Flyt's. Transceiver, probe and shovel — and on this hill especially: avalanches have run here, and it does not look like it. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "85 m",
      endLabel: "546 m",
      distanceLabel: "2.7 km",
      caption: "479 metres of ascent over 2.69 km from Kilkam: the ski track past the kindergarten, the ridge southward — and the gully south of Nattmålsfjellvatnet to the cairn at 546.",
    },
  },
  horntindan: {
    intro:
  ...
  tverrfjellet: {
    ...
    ascent: [
      "From the bays along Austerfjordveien at Melåa — 12 m; the source's F104 is today's fv. 7784 — follow the tractor road on the north side of Melåelva: 23 m where the line stands in it, and the power line is crossed on the moors at 171. The band from 0 to 100 measures 4.7 degrees over the first kilometre and a bit.",
      "The forest does not end until 419 m after 3.24 km — the round's highest treeline — and Tverrelvfoten, the 577 m hill, is passed on its west side as the source says. The band from 200 to 300 is the tour's steepest at 14.0 degrees; the steepest single stretch, 23.9 between 242 and 262 m, sits in the forest hillside.",
      "Then the fine open ground opens straight up toward the summit: 650 and 766 m where the line is pinned, and the cairn at 889. Northward the mountain falls 49.7 degrees toward the col that separates it from the 921 knoll — that is another mountain, and the gap between them is why the height in the book and the height on the screen are not the same number.",
    ],
    descent: [
      "South-facing skiing at 15–25 degrees all the way home — simple but fun, says the source, and the flank probe agrees: south-east and south-west from the summit measure a mean 5.6 to 5.8 degrees, south 13.0. This is the tour for newcomers with some length in their legs, and for everyone on clear March days.",
      "The one rule: do not overshoot the summit. North of the cairn the mountain falls 49.7 degrees in the window 80 to 140 metres out, down toward the col — in flat light that is the edge to know about on an otherwise kind mountain.",
    ],
    avalanche: [
      {
        title: "The route",
        body: "KAST 1 – Easy by Fri Flyt, and the terrain model agrees: 14.0 degrees in the steepest band, 23.9 in the steepest stretch, and a south side measuring a mean 13.0 from the cairn. This is the round's kindest line on paper — and the bulletin still gets read, because the moors and the hillside collect snow from the ground above.",
      },
      {
        title: "The north side",
        body: "The summit's one steep edge faces north, toward the col: 49.7 degrees in the steepest window. The descent goes south and has no reason to approach it — but in fog the cairn and the edge are closer together than map-feel suggests.",
      },
      {
        title: "Before you go",
        body: "Tverrfjellet lies in the Sør-Troms forecast region, an A-region with a daily avalanche bulletin — alone in the round: the other four summits answer to Lofoten og Vesterålen. Check varsom.no. The February–April season is Fri Flyt's. Transceiver, probe and shovel — on a KAST 1 tour too.",
      },
    ],
    elevationProfile: {
      startLabel: "12 m",
      endLabel: "889 m",
      distanceLabel: "5.5 km",
      caption: "885 metres of ascent and 5.53 km from Melåa along the tractor road, across the moors at the power line and west of Tverrelvfoten — the treeline at 419 m, and the steepest ground, 23.9 degrees between 242 and 262 m, in the forest hillside.",
    },
  },
  spanstinden: {
    intro:
  ...
  sorvikfjellet: {
    intro:
      "560 metres of ascent over 3.60 km from the Kilbotnveien to Sørvikfjellet — a steep ski hill close to town with several lines and high speed, and with the source's plainest avalanche sentence of the round: «be aware that avalanches run on the steepest slope every year.» KAST 3 – Complex, ice axe and crampons on the list. Grade 4.",
    ascent: [
      "From the lay-by on the Kilbotnveien — 61 m — to the junction at Nordvikmyra towards Kilbotn, 57 m. From there the instruction is the source's own: aim at the summit cairn and follow the easiest ground a little south of the top. The band from 0 to 100 m measures a mean 1.5 degrees, over 1595 metres of ground — the bog takes the first kilometre almost flat.",
      "In late winter Nordvikelva right by the road can be wide, and the source suggests rubber boots for the first hundred metres and a change into ski boots after that. On through the hillside towards the mountain, 63 m, and up above the forest at 201.",
      "The forest lets go at 362 m after 2.61 km. The steepest 100 m band measures a mean 20.6 degrees between 400 and 500 metres, over 266 metres of ground, and the steepest single step, 26.1 degrees, sits between 487 and 512. The cairn is 607 — the register and the source do not quite agree here, since Fri Flyt writes 600, and the card carries the DTM1 height as it does everywhere else.",
    ],
    descent: [
      "The descent follows roughly the same way as the ascent. Ski a few hundred metres to the south and you find a steep couloir of some 150 vertical metres that the source thinks is genuinely worth it — but that is a line, not the way back.",
      "The reason the route goes in a little south of the top is in the measurement: south is the gentle side at 5.4 degrees on average, south-west 6.6 and north-west 8.6. North-east measures 33.9 on average with a 45.3 window 180–240 metres out, and east 32.4 with 44.7 at 350–410.",
    ],
    avalanche: [
      {
        title: "The slope that runs every year",
        body: "The source writes that avalanches run on the steepest slope every year. The measurement finds it: the north-east side holds 33.9 degrees on average with a 45.3 window 180 to 240 metres out — right in the band where slabs release most often. The route comes in from the east and rounds south of the summit precisely to stay clear, and that is not a detail to improvise away on the way down.",
      },
      {
        title: "The couloir south of the route",
        body: "A few hundred metres south of the ascent lies a couloir of some 150 vertical metres that the source calls really worth skiing. It is a couloir: it collects whatever comes from above and offers no way off to the side. Ice axe and crampons are on the source's list for this mountain, and this is where they belong.",
      },
      {
        title: "Before you go",
        body: "Sørvikfjellet sits in the Sør-Troms forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The January–April season is Fri Flyt's. Transceiver, probe and shovel — and ice axe and crampons where the source demands them. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "61 m",
      endLabel: "607 m",
      distanceLabel: "3.6 km",
      caption: "560 metres of ascent over 3.60 km from the Kilbotnveien: the junction at Nordvikmyra, the bog and the hillside — and in to the cairn at 607 a little south of the top.",
    },
  },
  melaaksla: {
    intro:
      "965 metres of ascent over 5.99 km from Melå to Melåaksla — a summit that took three candidates to find: the register's name stands on the 747 shoulder in the north, the first seed landed on the 959.6 top to the south-east, and the published 915 is the top at 915.7 midway between them. The tractor road on the south side of the river to Dalbotnen, past the hut and the long ridge south. A descent of 15–25 degrees with some sections of 30 — splendid varied ground, says the source. Grade 2.",
    ascent: [
    ...
    elevationProfile: {
      ...
      endLabel: "916 m",
      distanceLabel: "6.0 km",
      caption: "965 metres of ascent over 5.99 km from Melå: the tractor road to Dalbotnen, past the hut towards the 505 knoll — and the long ridge south to the cairn at 916, west of the tarn at 717.",
    },
  },
  "rundfjellet-harstad": {
    intro:
      "774 metres of ascent over 6.86 km from the DNT hut at Bjørnhaugen to Rundfjellet — the round's longest tour and chapter 1's biggest mountain. The source calls it «some approach and fine skiing in cruising country», and the terrain model agrees: the steepest band on the whole line measures 18.5 degrees. The name is qualified because the app already has a Rundfjellet, the 803 m one in Vågan. KAST 1 – Simple. Grade 2.",
    ascent: [
      "From the large car park by the DNT hut — 212 m — the line drops towards Storvatnet and follows its west shore south: 155, 145 and 140 m where the corridor is anchored. The lake is large, and the 118 metres you give back here are half the reason the source states 800 for a mountain that stands 656 metres above the hut.",
      "The source writes «cross Rundfjellvatnet», but the line stays on land north of the tarn — the same rule as everywhere else in the app. From the south-west end of Storvatnet the route climbs the stream valley on the north side of spot height 339, which the terrain model measures at 337.7. Keeping to the middle of the valley is not a casual phrase: there is avalanche terrain on both sides, and it is the only hazard instruction the source gives.",
      "Past Rundfjellvatnet at 300 m and onto the north-east ridge — 602 where the corridor stands in it. The forest does not let go until 344 m after 4.98 km, the longest walk through trees in the round. The steepest 100 m band measures a mean 18.5 degrees between 700 and 800 metres, over 325 metres of ground, and the steepest single step, 23.9 degrees, sits between 509 and 529 m.",
    ],
    descent: [
      "The same ridge home. The source promises «mostly 20–25 degree skiing, but some sections are 30», and the line stays under that the whole way: no band averages more than 18.5 degrees.",
      "The flank sweep puts the steep ground where the source does not send you: south of the cairn there is a 54.6 window 20–80 metres out, and south-east 50.3 only 10–70 metres out. South-west is the gentle side at 8.8 degrees on average. The ridge to the north-east is the route, and it measures 20.2.",
    ],
    avalanche: [
      {
        title: "The stream valley",
        body: "The source tells you to keep to the middle of the stream valley north of spot height 339 to avoid avalanche terrain on both sides. That is an instruction about placement, not about angle: the valley floor itself is gentle, but it lies between two flanks that can deliver. Hold the middle, and read the snow on the sides before you go in.",
      },
      {
        title: "The summit has a steep side",
        body: "The north-east ridge is gentle — 20.2 degrees on average — but south and south-east of the cairn the mountain falls at 54.6 and 50.3 degrees in its steepest windows, the south-east one only 10 to 70 metres from the top. On a mountain the source calls cruising country, it is worth knowing where the edge runs.",
      },
      {
        title: "Before you go",
        body: "Rundfjellet sits in the Sør-Troms forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The February–April season is Fri Flyt's. Transceiver, probe and shovel. The tour is long for its grade — nearly seven kilometres in — so the hour of the day decides what snow you meet on the way back. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "212 m",
      ...
      caption: "774 metres of ascent over 6.86 km from Bjørnhaugen: the west shore of Storvatnet, the stream valley north of spot height 339 — and the north-east ridge to the cairn at 868.",
    },
  },
  jakobstinden: {
    intro:
      "1017 metres of ascent over 7.40 km from the same Y-junction as Kongsviktinden — four kilometres of winter-closed road where the band below 100 m measures 1.2 degrees, then the moors at Sætran, the broad ramp and the plateau to the summit with the pinnacle. The steepest single stretch, 31.0 degrees between 741 and 768 m, sits exactly where the ramp meets the ridge — and where the cornice can stand, says the source: keep left, to the south. KAST 2 by Fri Flyt, ice axe and crampons, and a mountain so little visited that untracked snow is likely.",
    ascent: [
      ...
      "Then comes the ramp: 394 m where the line takes it, the upper ramp at 502, and the treeline at 388 m after 5.03 km. Above the ramp toward the ridge the cornice can stand — keep left, south, through the section, exactly where the steepest single stretch measures 31.0 degrees between 741 and 768 m.",
      "The plateau at 720 carries you the last stretch to the summit at 976 — the register resolves 976.0 on the border between Kvæfjord and Tjeldsund. The pinnacle stands north of the cairn: M3 climbing for those who want it, with 25 metres of rope for the rappel — it is the view, not the tour. You give back 66 metres along the way.",
    ],
    descent: [
    ...
    elevationProfile: {
      ...
      caption: "1017 metres of ascent and 7.40 km from the Y-junction at Kongsvik across the moors at Sætran and up the broad ramp — the treeline at 388 m, and the steepest stretch, 31.0 degrees between 741 and 768 m, where the cornice can stand.",
    },
  },
  "stortinden-sortland": {
    intro:
  ...
  reinspalen: {
    intro:
      "1367 metres of ascent over 7.85 km for a 1118 summit — Reinspælen is Kvæfjord's highest, and the ridges there collect 255 metres given back along the way: plenty of up and down, as both the source and the trip reports say. KAST 3 – Complex with ice axe and crampons; the line measures 21.0 degrees in its steepest hundred-metre band, and the steepest sustained stretch — 37.9 degrees between 331 and 357 m — sits in the step onto Kobberyggen, while the seriousness sits in the transition to the exposed summit ridge, where the reports describe scrambling.",
    ascent: [
      "From Våtvoll on the fv. 85 along Gullesfjorden — 5 m, parking in the pockets along the road as the source says. Up Kobberyggen: the band from 0 to 100 measures 8.9 degrees and the forest ends at 378 m after 2.30 km, before the ridge gives back its first notch — 86 metres down to 335 before Geitryggen takes over.",
      ...
      "The summit ridge is the serious part: an exposed traverse with cornices and avalanche terrain toward Litjedalen, where the ridge rears toward the cairn; the line's steepest stretch is lower down, 37.9 degrees between 331 and 357 m in the step onto Kobberyggen. The axe and crampons are for these metres; the trip reports call it scrambling. The register resolves 1117.4 against a published 1118.",
    ],
    descent: [
    ...
    avalanche: [
      {
        title: "The route",
        body: "KAST 3 – Complex by Fri Flyt. The ridges are kind — 21 degrees in the steepest band — and all the seriousness is gathered in the summit ridge: cornices, and walls on both sides of the traverse — the line's steepest 30 metres, 37.9 degrees, sit low on Kobberyggen. Grade 4 on the card.",
      },
      {
        title: "The summit ridge",
      ...
      },
      {
        ...
        body: "255 metres are given back on the ridges — 255 metres to be climbed again on the way home. Count the hours accordingly: the source gives 6–7, and they are honest.",
      },
      {
        title: "Before you go",
    ...
    elevationProfile: {
      ...
      caption: "1367 metres of ascent and 7.85 km from Våtvoll over Kobberyggen and Geitryggen, with the treeline at 378 m and the steepest ground — 37.9 degrees between 331 and 357 m — in the step onto Kobberyggen.",
    },
  },
  satertinden: {
    intro:
  ...
  kongsviktinden: {
    intro:
      "1051 metres of ascent over 8.05 km from the Y-junction before the barrier — nearly half the tour is the winter-closed road into Kongsvikdalen, where the band below 100 m measures 1.4 degrees over 3625 metres of ground. Then the mountain takes over: the summer trail at Sætran, the south contour across the plateau, and a summit that collects 1051 metres for its 980 because the plateau rolls — you give back 96 along the way. KAST 2 by Fri Flyt, with ice axe and crampons on the gear list for the wind-packed snow and icing near the top.",
    ascent: [
    ...
    descent: [
      ...
      "The second documented route climbs the Østsia from the petrol station in Kongsvik — 923 metres of ascent over 4.38 km, under half the normal route's length, up the scooter track in Håkadalen and the big slanting ramp. The source describes it as a descent and adds that you can of course climb it too; most of it is 20–30 degrees, with a steepest step of 30.9.",
    ],
    avalanche: [
      {
        title: "The route",
    ...
    elevationProfile: {
      ...
      caption: "1051 metres of ascent and 8.05 km from the Y-junction at Kongsvik: the winter-closed road to Sætran, the summer trail and the south contour across the plateau — the treeline at 317 m, the steepest stretch, 31.6 degrees, between 291 and 310 m.",
    },
  },
  "snotinden-tjeldsund": {
    intro:
      "979 metres of ascent over 4.26 km from Dalelva's outlet in Fiskefjorden — the same car park as Taraldsviktinden, opposite side of the valley. The tractor road up Norddalen deals with the steepest ground: the band from 100 to 200 m measures 21.7 degrees and the tour's steepest single stretch, 27.5 degrees, sits between 284 and 307. Then the long Marsslottfjellet levels out, and the ridge carries south-west to the summit. KAST 1 by Fri Flyt — but the source gives 7–8 hours, so plan the day accordingly.",
    ascent: [
      "From the big car park at Dalelva's outlet — 5 m — start as for Taraldsviktinden, then take the tractor road up Norddalen: 219 m where the line stands in the valley, the treeline at 307 after 1.34 km, and 412 at the valley's top. The steepest single stretch, 27.5 degrees between 284 and 307 m, sits here.",
      "Marsslottfjellet — the register's spelling, with two s's — is the tour's character: long and open, 632 m where the line takes it and 798 where the ridge swings south-west. The band from 500 to 600 measures 10.0 degrees and the band from 700 to 800 10.1 — kilometres of even skinning.",
      "The ridge south-westward passes 855, the summit flank reads 938, and the cairn stands at 980 — the register writes Snytinden and resolves 979.7. You give back only 4 metres on the whole tour, and the band from 900 to 1000 measures 13.7 degrees toward the top.",
    ],
    descent: [
      "The same way down, and that is the point of the north-east side: only three slopes of about 25 degrees in the whole descent, says the source — and the measurement agrees: no hundred-metre band over 21.7. Flow across Marsslottfjellet, and speed all the way down Norddalen when the forest holds snow.",
      "The south-west side — via Snytindlemman toward Revskarvatnet and over Bollfjellet, all three register names — is the demanding variant with its own snowpack assessment. The flank probe gives the south-east side 49.8 degrees and the south-west 42.7; stay on the ridge you came up.",
    ],
    avalanche: [
      {
        title: "The route",
        body: "KAST 1 – Easy by Fri Flyt, and the terrain model agrees: 21.7 degrees in the steepest band — in the forest low on the tour — and 29.0 in the steepest stretch. Up on Marsslottfjellet it is gentler than any other mountain in the round. Crampons worth having on crust days, says the source.",
      },
      {
        title: "The south and east sides",
        body: "The flank probe from the summit gives 49.8 degrees to the south-east and 42.7 to the south-west — the steep sides face away from the normal route, toward Snytindlemman and Revskarvatnet. North and north-west, where the route goes, measure a mean 11.6 to 12.1.",
      },
      {
        title: "Before you go",
        body: "Snøtinden i Tjeldsund lies in the Lofoten og Vesterålen forecast region, an A-region with a daily avalanche bulletin through the season — check varsom.no. The February–April season is Fri Flyt's, and the source's 7–8 hours makes this the round's longest day despite the short kilometres. Transceiver, probe and shovel.",
      },
    ],
    elevationProfile: {
      startLabel: "5 m",
      endLabel: "980 m",
      distanceLabel: "4.3 km",
      caption: "979 metres of ascent and 4.26 km from Dalelva's outlet up Norddalen and across the long Marsslottfjellet — the treeline at 307 m, and the steepest ground, 27.5 degrees between 284 and 307 m, where the tractor road ends.",
    },
  },
  taraldsviktinden: {
    intro:
  ...
  nonstinden: {
    intro:
      "973 metres of ascent over 5.72 km from the Gullesfjordbotn roundabout to a summit without one gentle side: all eight flank probes measure a mean 21.5 to 38.9 degrees, and the source's four steep descents are exactly that. The normal route goes west of the fjord head, up the ridge from 155 and west into the steep gully — the tour's steepest stretch, 31.1 degrees, sits between 542 and 563 m where the gully delivers onto the plateau. Complex by Fri Flyt, ice axe and crampons, grade 4.",
    ascent: [
      "From the big car park at the roundabout — 49 m — walk west around the fjord head, past the parking on the west side, giving back 46 metres down to the shore before the ridge foot receives you at 75. The forest ends as early as 125 m after 2.77 km — most of the ski tour is above the treeline.",
      "The ridge northward is the first act: 289 m where the line stands on it, with the band from 100 to 200 at 20.5 degrees. Before the steeper ground you swing west into the gully at 376 — and here the mountain shows itself: the band from 500 to 600 measures 24.1 degrees, with the tour's steepest single stretch, 31.1, between 542 and 563.",
      "The gully delivers you onto the plateau west of the 685 height — 475 m where the line takes it — and the traverse westward passes 793 before the cairn at 930; the register resolves 929.9. You give back 92 metres along the way, the shore around the fjord head included.",
    ],
    descent: [
      "The same way down is the normal: 25–40 degrees by Fri Flyt, and the gully demands the same snow down as up. The other three — the north side with sections at 30–40, the west side toward Løbergsdalen at 30–40, and Karirenna — are the reasons the mountain is in this book.",
      "Karirenna to the north-east is the expert line: 45–50 degrees with serious rockfall hazard in its upper part, and the source demands stable, well-filled snow. The flank probe gives the north-east flank 50.3 degrees — the day for it is chosen with care, and chosen rarely.",
    ],
    avalanche: [
      {
        title: "The route",
        body: "Complex by Fri Flyt, and the measurement explains why: none of the summit's eight sectors measures under a mean 21.5 degrees, and the normal route itself holds 24.1 in the steepest band with the gully at 31.1. Ice axe and crampons on the gear list. This is the round's most serious mountain — grade 4.",
      },
      {
        title: "The gully and the cornices",
        body: "The gully of the normal route is the terrain trap on the way up: steep enough to slide, confining enough to bury. Take it one at a time, and turn around when the snow says no. Karirenna adds rockfall in its upper part — it is another category than the rest of the mountain.",
      },
      {
        title: "Before you go",
        body: "Nonstinden lies in the Lofoten og Vesterålen forecast region, an A-region with a daily avalanche bulletin through the season — check varsom.no. The January–April season is Fri Flyt's. Transceiver, probe and shovel — and ice axe and crampons, as the gear list says.",
      },
    ],
    elevationProfile: {
      startLabel: "49 m",
      ...
      caption: "973 metres of ascent and 5.72 km from the Gullesfjordbotn roundabout west of the fjord head, up the ridge and the steep gully to the plateau — the treeline at 125 m, and the steepest ground, 31.1 degrees between 542 and 563 m, in the gully itself.",
    },
  },
  snotindan: {
    intro:
      "1544 metres of ascent over 8.80 km for a 996 summit — Snøtindan is the tour where the col costs more than the top: 561 metres are given back along the way, over Løbergskaret and the tarn shelves, and the line keeps to land past all the lakes where the source crosses on ice. KAST 3 – Complex with ice axe and crampons, 8–9 hours by the source, and a 30–40 degree summit slope at the end. The register writes Snytindan; ut.no writes Stor Snytindan; the card follows Fri Flyt.",
    ascent: [
    ...
    descent: [
      "Down the same way — the summit slope first, while you know what the snow did on the way up, then the shelves and the climb back over Løbergskaret: 185 of the 561 given-back metres must be climbed again on the way home. The north sector from the summit measures 13.6 degrees mean — the way the line came.",
      ...
      "The source gives two starts, not one: «A parking of its own along the R85, right on the south side of the river mouth. For the east route you park at Gullesfjordbotn campsite.» The east route is the second, and it comes in from the opposite side of the mountain. From the campsite at 3 m the line keeps the north side of Vesterelva past 86 and 91, over the lake at 76 — 121 where the line runs — and on between the lakes at 167 to the lake at 113, crossed westward at 278. Then the steep line the source puts at 30–40 degrees, up past 293 and 326 to the lake at 289 at 332, and south along the gentle ridge at 440 to the 667 top. From there below the top of Vestbotntinden — the line crosses the shoulder at 864, not the 935 summit — and down 259 metres to Øvre Storelvvatnet at 605, across the lake, and back up at 652 and 803 onto the route from Snytindhytta that rounds the summit on the west. 1360 metres of climbing over 8.52 km against 1544 over 8.80 km from Løbergsbukta: a little shorter, less ascent, 367 metres given back against 561 — two traverses of the same mountain, each from its own fjord. The line stands on ice in four places, and all four are the source's own: 135 metres over the lake at 76, 90 metres over the lake at 115 — the source's «vann 113» — 191 metres over the lake at 274, and 150 metres over Øvre Storelvvatnet at 590. «Having crossed vann 76», «vann 113 is crossed westward», «pole across the lake», it writes. The forest lets go at 212 m after 2.46 km. The band from 400 to 500 m measures 21.1 degrees and the steepest 30 m window 36.5 between 973 and 996, in the summit slope. Ice axe and crampons are in the fact box for both routes.",
    ],
    avalanche: [
      {
        title: "The route",
    ...
    elevationProfile: {
      ...
      caption: "1544 metres of ascent and 8.80 km from Løbergsbukta up the middle of Løbergsdalen, over Løbergskaret and past the lakes on land, with the treeline at 287 m and the steepest ground — 33.8 degrees between 947 and 974 m — in the summit slope.",
    },
  },
  fiskefjordtindan: {
    intro:
      "1044 metres of ascent over 7.27 km from Kanstadbotn to a summit with two truths: the register point stands on the north top, which the terrain model reads at 998.9 — but Fri Flyt's 967 is the south top, which climbs to 964.7, and that is where the route goes. The south-west side is kind — the band from 500 to 600 measures 4.0 degrees — but the east ridge at the end is exposed, with the tour's steepest stretch at 32.8 degrees just below the cairn and an east face measuring 67.2 at its steepest. Axe and crampons in the pack.",
    ascent: [
      "From the parking bay at Kobbedalselv bridge in Kanstadbotn — 15 m — follow the summer trail north-east: 176 m where the line takes it, the treeline already at 225 after 1.58 km, and the hillside at 369. The band from 300 to 400 measures 5.9 degrees — this is gentle, open skinning.",
      "The ridge between the lakes is the tour's middle act: 578 m where the line stands between the Kobbedal lakes, 702 further up, and the band from 500 to 600 is the tour's gentlest at 4.0 degrees over 1582 metres of ground. The undulation here is why the tour collects 1044 metres for a 965 top — you give back 94.",
      "The west flank at 856 delivers you to the finale: the ridge eastward, exposed as the source says, with the steepest single stretch — 32.8 degrees between 885 and 907 m — just below the top. The cairn stands at 965; the north top with the register point and its 998.9 lies 900 metres further north, across a col, and is not the tour.",
    ],
    descent: [
      "The same way down: a comfortable 20–25 degrees by Fri Flyt once the east ridge is behind you, and the measurement agrees — no hundred-metre band below the summit section passes 15.2. The west flank and the ridge between the lakes are skiing for all legs.",
      "The north-east route down the east side goes in a fine gully of up to 40 degrees with plenty of runout zones — the flank probe gives the whole east face 58.9 to 67.2 degrees in its steepest windows. It demands stable snow, and it is another tour than this one.",
    ],
    avalanche: [
      {
        title: "The route",
        body: "KAST 1 – Easy by Fri Flyt, and most of the line agrees: 15.2 degrees in the steepest band, and gentler than that for hours. But ice axe and crampons stand on the source's gear list for the east ridge — 32.8 degrees measured, exposed above an east face of 67 — and it is the Gråfjell rule that puts grade 3 on the card.",
      },
      {
        title: "The east side",
        body: "The gully of the north-east route holds up to 40 degrees with plenty of runout zones, and the flank probe gives the whole east flank 58.9 to 67.2 degrees in its steepest windows. On the summit, distance from the east edge is cheap insurance — especially in flat light, and especially with a cornice.",
      },
      {
        title: "Before you go",
        body: "Fiskefjordtindan lies in the Lofoten og Vesterålen forecast region, an A-region with a daily avalanche bulletin through the season — check varsom.no. The January–April season is Fri Flyt's. Transceiver, probe and shovel — and ice axe and crampons, as the gear list says.",
      },
    ],
    elevationProfile: {
      startLabel: "15 m",
      endLabel: "965 m",
      distanceLabel: "7.3 km",
      caption: "1044 metres of ascent and 7.27 km from Kanstadbotn across the ridge between the Kobbedal lakes to the south top at 965 — the treeline at 225 m, and the steepest ground, 32.8 degrees between 885 and 907 m, on the exposed east ridge.",
    },
  },
  moysalen: {
    intro:
  ...
  forselvtinden: {
    intro:
      "1180 metres of ascent over 8.29 km from the Møysalen car park on the E10 to Forselvtinden — the longest tour of the round, and the only route in the app that crosses the summit of another tour on the way. The source's own description opens with «follow the route up Lakselvtindan», and it is 747 m you stand on before carrying on west. 296 of those metres you give back. Fri Flyt gives KAST 2 – Challenging, but asks you to consider whether the skis should come up: grade 4.",
    ascent: [
      "From the car park — 23 m — as on Lakselvtindan: the north shore of Storvatnet at 85, north of spot height 258, and 217 m where Lakselva is crossed eastward. The forest lets go at 220 m after 2.48 km, and the band from 300 to 400 is the steepest on average at 19.0 degrees over 313 metres of ground.",
      "Up onto Lakselvtindan, 747 m, and then west along the ridge until you stand due north of spot height 790 — DTM1 measures 790.6, and the corridor stands at 754 just north of it. Between 700 and 800 m lie two kilometres of near-flat high ground: the band measures 2.1 degrees on average over 1955 metres of ground.",
      "Carrying on north the route keeps to the lower — western — side of the ridge, 668 m where the corridor is anchored, because there are steep sections just before the climb begins. Then the south ridge: the steepest step on the whole line, 33.1 degrees, sits between 834 and 863 m, right under the cairn at 907.",
    ],
    descent: [
      "The same way home, mostly under 20 degrees with a couple of sections at 25–30, says the source. But the way home is a second ascent too: the 296 metres you gave back have to be taken again, and Lakselvtindan stands in the way once more.",
      "The flank sweep explains why the south ridge is the only way up and down. S measures 22.5 degrees on average with a 40.8 window 70 to 130 metres out — the steep section the source names. N, NE, W and NW run 46.9 to 48.6 on average with windows from 60.6 to 75.9, and east holds 76.8 only 30 to 90 metres out.",
    ],
    avalanche: [
      {
        title: "The section before the summit",
        body: "The source calls the south ridge a fine airy stretch with one steep section before the top, and asks you to consider whether the skis should come up. The measurement agrees: 40.8 degrees in the window 70 to 130 metres out, and 33.1 degrees in the steepest single step the line actually takes, between 834 and 863. Crampons and an ice axe are recommended, and many carry the skis for the last part.",
      },
      {
        title: "The west side of the ridge",
        body: "Going north along the ridge you keep to the lower side, which is the west. The source is explicit about why: there are steep sections just before the climb onto the ridge towards Forselvtinden begins, and the line goes round them rather than over. East of the ridge the ground falls at 76.8 degrees in its steepest window.",
      },
      {
        title: "Before you go",
        body: "Forselvtinden sits in the Lofoten og Vesterålen forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The February–April season is Fri Flyt's, and 8.29 km with 296 metres to regain makes this a tour where the hour of the day decides what snow you meet on the way back. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "23 m",
      endLabel: "907 m",
      distanceLabel: "8.3 km",
      caption: "1180 metres of ascent over 8.29 km from the Lofast: over Lakselvtindan at 747, west to north of spot height 790 — and the south ridge to the cairn at 907.",
    },
  },
  middagsfjellet: {
    intro:
      "762 metres of ascent over 2.91 km from the Gullesfjordbotn roundabout — the round's shortest tour, and an exercise in choosing right: the normal route stays under 30 degrees the whole way, with 20.6 as its steepest band and 27.3 as its steepest stretch, while the surrounding ground measures 30–40 and the west side toward Storskardet 54.4 at its steepest. KAST 3 – Complex by Fri Flyt, precisely because the gentlest line is surrounded by steeper.",
    ascent: [
      "From the big car park at the roundabout — 49 m, the same start as Nonstinden — climb the snow-covered hillside west of Tverrelva: 194 m where the line stands in it, with the treeline at 265 after 1.04 km. The band from 100 to 200 measures 17.4 degrees.",
      "Above the treeline the even climbing continues: 461 m where the line is pinned, and the bands from 200 to 700 measure 18.2 to 20.6 degrees — never flat, never steep, but surrounded by steeper: the source is clear that the gentlest line is to be chosen, because the route is ringed by more avalanche-prone terrain.",
      "Blåberget — the source's name; the register does not carry it here — is passed at 708, the summit flank reads 767, and the cairn stands at 810; the register resolves 809.8. The tour's steepest single stretch, 27.3 degrees between 437 and 454 m, sits mid-hillside. You give back one metre on the whole tour.",
    ],
    descent: [
      "The same way down, or the Tverrelva valley when the snowpack is good — and with possible icing above the treeline, crampons are worth considering, says the source. The north side from the summit measures a mean 9.5 degrees: the skiing is kind where the line goes.",
      "The west side toward Storskardet is the steeper variant with more sheltered snow — and avalanche terrain demanding its own assessment: the flank probe gives west 54.4 degrees in the window 60–120 metres out and south-west 49.3. East measures 40.9. The kind ground on this mountain is narrow, and that is the point of it.",
    ],
    avalanche: [
      {
        title: "The route",
        body: "KAST 3 – Complex by Fri Flyt — not because the normal line is steep, but because it is surrounded: the line measures 20.6 degrees in its steepest band and 27.3 in its steepest stretch, while the ground around holds 30–40. Choose the gentlest line, says the source, and that is the whole tour in one sentence. Grade 3.",
      },
      {
        title: "The icing and the sides",
        body: "Above the treeline it can ice up — consider crampons, or turn around. The west side toward Storskardet measures 54.4 degrees at its steepest and is avalanche terrain with its own assessment; the east side measures 40.9. The descent in the Tverrelva valley demands good snow cover and the same judgement.",
      },
      {
        title: "Before you go",
        body: "Middagsfjellet lies in the Lofoten og Vesterålen forecast region, an A-region with a daily avalanche bulletin through the season — check varsom.no. The December–April season is Fri Flyt's, the longest in the round together with the Haukebøtinden class. Transceiver, probe and shovel.",
      },
    ],
    elevationProfile: {
      startLabel: "49 m",
      endLabel: "810 m",
      distanceLabel: "2.9 km",
      caption: "762 metres of ascent and 2.91 km from the Gullesfjordbotn roundabout up the hillside west of Tverrelva and over Blåberget — the treeline at 265 m, and the steepest ground, 27.3 degrees between 437 and 454 m, mid-hillside.",
    },
  },
  strandtinden: {
    intro:
      "1144 metres of climbing and 5.79 km from the E10 at sea level to the summit at 1076 m — the great classic of the Harstad area, and a mountain with no gentle side. The steepest hundred-metre band on the route is 19.8 degrees between 600 and 700 m and the steepest step 29.1 between 736 and 761, but the flanks around it measure 40 to 64 degrees in their steepest windows. The route takes the summit from the west because west is the one edge that does not.",
    ascent: [
    ...
    elevationProfile: {
      ...
      endLabel: "1076 m",
      distanceLabel: "5.8 km",
      caption: "1144 metres of climbing and 5.79 km from the E10 at 21 m up through Heggedalen past 146, the gully at 510 and spot height 570, across the bowl to 805 and west along the bench to the north-west ridge at 886, 952 and 1040.",
    },
  },
  jotind: {
    intro:
  ...
  forkledalstindan: {
    ...
    avalanche: [
      ...
      },
      {
        ...
        body: "The flank sweep finds a window between 37.7 and 60.0 degrees within the first 100 metres of the cairn on all eight bearings. North-east is the mildest at 37.7 and 23.5 on average; south-west is gentle for the first 340 metres and then holds 46.4. The pitch down from spot height 790 to lake 355 on the north side is KAST 3 in the source's own assessment.",
      },
      {
        title: "Before you go",
        body: "Forkledalstindan sits in the Lofoten og Vesterålen forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The February–April season is Fri Flyt's. Transceiver, probe and shovel, and ice axe and crampons — here they are not a recommendation but what the traverse requires. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "23 m",
      endLabel: "901 m",
      distanceLabel: "5.4 km",
      caption: "985 metres of ascent over 5.41 km from Litlvatnet: the north side of spot height 462, the mountainside to the 700 m top — and the traverse on to the cairn at 901.",
    },
  },
  lakselvtindan: {
    intro:
      "819 metres of ascent over 5.46 km from the Møysalen car park on the E10 to Lakselvtindan — the gentlest summit of this round. The flank sweep measures 5.4 degrees on average to the north-west and 17.7 to the south-west, where the ridge arrives, and no bearing holds a window steeper than 50.4. Fri Flyt gives KAST 2 – Challenging and puts ice axe and crampons on the kit list; grade 3 comes from that kit and the crust the source warns about, not from steepness.",
    ascent: [
      "From the large car park at Ingelsfjordeidet — 23 m — the line runs along the north shore of Storvatnet: 85 m where the corridor is anchored. The source writes «cross Storvatnet», but the same book's own Forkledalen route from this car park says «follow the north side of Storvatnet». The map carries the land line; the ice is not a premise.",
      "Up between Tverrelva and Lakselva — 158 m — and north of spot height 258, which DTM1 measures at 258.3. The forest lets go at 220 m after 2.53 km, and the band from 300 to 400 is the steepest on average at 20.0 degrees over 261 metres of ground.",
      "Then it flattens out inland: 217 m where Lakselva is crossed eastward, and from there the ridge — 481 m where the corridor stands in it — all the way to the cairn at 747. The steepest single step on the whole line, 26.2 degrees, sits low down between 43 and 65 m, in the hillside above the car park.",
    ],
    descent: [
      "The same ridge home. 95 of the 819 metres you give back on the way up, most of it in the flat stretch before Lakselva, and no band on the line averages more than 20.0 degrees. The source mentions crust, and ski crampons belong in the pack alongside the axe and the boot crampons.",
      "The variants are a different matter from the normal route. Rødhammarrenna on the east side is KAST 3: the bowl west of the normal route is 30–40 degrees, then a 45-degree pitch down into the couloir, and avalanche terrain the whole way through. The west side down to lake 355 between Forselvtinden and Forkledalstinden holds a steep section of 30–40 degrees.",
    ],
    avalanche: [
      {
        title: "Rødhammarrenna",
        body: "The east side is not the normal route. The source rates it KAST 3 and describes a 45-degree pitch down into the couloir, with avalanche terrain the whole way through because the walls around it can carry a great deal of snow. The couloir itself is 15–20 degrees with a few sections at 25–30 — it is the entry and what hangs above it, not the runout, that decides whether it slides.",
      },
      {
        title: "Crust and wind",
        body: "This is a tour where the problem is as often hard ground as unstable snow. The source asks you to bring ski crampons, and from 481 m upward the ridge is scoured and wind-packed — that is where the ice axe and crampons on the kit list belong.",
      },
      {
        title: "Before you go",
        body: "Lakselvtindan sits in the Lofoten og Vesterålen forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The February–April season is Fri Flyt's own. Transceiver, probe and shovel — and ice axe and crampons where the source demands them. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "23 m",
      endLabel: "747 m",
      distanceLabel: "5.5 km",
      caption: "819 metres of ascent over 5.46 km from the Lofast: the north shore of Storvatnet, up between the rivers past spot height 258 — and the ridge east of Lakselva to the cairn at 747.",
    },
  },
  siriskolten: {
    intro:
  ...
  helligtinden: {
    ...
    ascent: [
      ...
      "Up to Finnvatnet at 282, and south-west to avoid the avalanche terrain as the source asks — 479 m where the line swings. The band from 600 to 700 measures 8.3 degrees up towards the ridge.",
      "Litletinden's north-east ridge from 645, the ridge south with a small descent — and the final push: the band from 800 to 900 is the steepest on average at 19.9 degrees, and the steepest single step on the line, 28.2 degrees between 646 and 665 m, sits below the 30 the source gives the ridge's two steepest sections — the line lies gentler than the crest there. The cairn stands at 948.",
    ],
    descent: [
      ...
      "Østskåla between Helligtinden and Litletinden is the variant: 31–35 degrees down to gentler ground along the south side of Tverrelva. The east flank averages 28.4 with a 57.2 window 100–160 m out — the bowl demands stable snow, and the line in any case gives back 15 of the 954 metres on the ridge's rolls.",
    ],
    avalanche: [
      {
        title: "The ridge",
    ...
    elevationProfile: {
      ...
      caption: "954 metres of ascent over 5.04 km from Breivikbotn: the Krokelva cabins, Finnvatnet at 282, south-west around the avalanche terrain — and the Litletind ridge from 645 to the cairn at 948.",
    },
  },
  kvasstinden: {
    intro:
      "933 metres of ascent over 4.08 km from the E10 at Austerstraumen to Kvasstinden — and a name Lødingen has two of. The south-eastern Kvasstinden measures 913 m in the terrain model; this one, the north-western, climbs to 831.6 against Fri Flyt's 831. The published height names the summit. KAST 1 – Simple, but with ice axe and crampons on the kit list and an airy top: grade 2.",
    ascent: [
      "From the large car park east of the Austerstraumen bridge — 3 m — south along the bogs on a steady rise: 146 m where the corridor stands. The book also writes «from the car park on Husjordøya», but Husjordøya lies between Vesterstraumen and Austerstraumen, and the mapped car park is east of the bridge. It is the parking line that can be checked.",
      "The crossing into Trolldalen goes just north of spot height 146 — the terrain model measures 148.4 — at 144 m, and then the line drops into the valley to 96. 104 of the 933 metres you give back there, and those are what the source's 910 metres of ascent include that the difference between sea and summit does not. The forest lets go at 242 m after 2.17 km.",
      "Up the valley to the south-east and onto the west ridge — 554 m where the corridor is anchored. The band from 700 to 800 is the steepest on average at 22.3 degrees over 244 metres of ground, while the steepest single step, 28.5 degrees, sits right down between 113 and 131 m. The last metres to the 832 summit are walked on the ridge from the west.",
    ],
    descent: [
      "Down the same way: some sections over 30 degrees, but the great majority around 20–25, says the source. A lot of wind- and sun-affected snow is the norm, and in good conditions — especially in the afternoon in late winter, in evening light — this is the run the source praises most.",
      "The summit itself is airy, and the source asks you to decide whether the skis are left below or carried up. The flank sweep shows why that is a question: west, where the ridge arrives, holds a 44.6 degree window 90 to 150 metres out, and south-west measures 38.7 on average. East is the gentle side at 15.9.",
    ],
    avalanche: [
      {
        title: "The north side",
        body: "The steeper variant down from the summit is KAST 3 in the source's own assessment, with a 30–40 degree pitch off the top. It gives fine skiing in good conditions, but it is not the way you came, and it is not a choice to make on the summit without having read the snow on the way up.",
      },
      {
        title: "Wind, sun and ploughing",
        body: "A lot of wind- and sun-affected snow is the norm on this ridge, and the south-west flank below it measures 38.7 degrees on average with a 53.8 window 60 to 120 metres out. The car park is also not always ploughed early in the season — worth knowing before you drive all the way out here.",
      },
      {
        title: "Before you go",
        body: "Kvasstinden sits in the Lofoten og Vesterålen forecasting region, an A-region with a daily avalanche bulletin through the season. Check varsom.no. The February–April season is Fri Flyt's. Transceiver, probe and shovel — and ice axe and crampons, which are on the source's list even though the tour is KAST 1. An empty page does not mean a safe mountain.",
      },
    ],
    elevationProfile: {
      startLabel: "3 m",
      endLabel: "832 m",
      distanceLabel: "4.1 km",
      caption: "933 metres of ascent over 4.08 km from Austerstraumen: the bogs south, down into Trolldalen north of spot height 146 — and the west ridge to the airy 832 summit.",
    },
  },
  rombakstotta: {
    intro:
  ...
  beisfjordtotta: {
    ...
    descent: [
      ...
      "The source gives a start other than Djupvik: «you can also start the tour from Narvik and follow the popular path that leads into Tøttdalen from the mini power station north-east of the ski lifts. The path takes you to Pumpvatn. From there you can follow the route description on toward Beisfjordtøtta.» That path is mapped the whole way. From the car park at Taraldsvikfossen at 205 m the line goes into Tøttadalen at 252 and 264, further in at 306, and reaches Pumpvatnet at 331 — 4.81 km of forest, against 300 metres up the steep slope from Djupvik. From there it is the same route: around the lake on land at 325 and 329, the stream valley at 449, Forsnesvatnet at 655 and 858, up toward the col at 1135 and 1257, and the ridge south over 1317 and 1418 to the cairn. 1351 metres of climbing over 9.03 km against 1428 over 7.19 km from the barrier: a start 145 metres higher, nearly two kilometres longer, and a much milder mountain on the way — steepest hundred-metre band 21.2 degrees from 1000 to 1100 m, steepest 30 m window 27.0 degrees between 884 and 904 against 38.4 on the normal route. No train or taxi back from here; the car is in town.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  pilan: {
    intro:
      "844 metres of ascent over 4.09 km from Laupstad on Austvågøya's quiet north side, with the view into Vesterålen from the cairn. Fri Flyt rates it KAST 1 – Simple with the steepest point under 30 degrees, and most of the line keeps that — steepest 100 m band 21.9 degrees. But the summit cone measures 35.3 degrees in its steepest 30 m window, between 763 and 786 m, and the measurement is the check for the grade: the card carries 3, not the source's number. The ridge gives back 23 vertical metres, and the tour runs from the fjord.",
    ascent: [
    ...
    avalanche: [
      {
        title: "The route",
        body: "KAST 1 – Simple by Fri Flyt, steepest point under 30 degrees — true for most of the line, but not for the summit cone: 35.3 degrees in the steepest 30 m window between 763 and 786 m. The card carries grade 3 on that measurement. Below 700 this is one of the kindest lines of the round.",
      },
      {
        title: "The cone",
    ...
    elevationProfile: {
      ...
      endLabel: "826 m",
      distanceLabel: "4.1 km",
      caption: "844 metres of ascent and 4.09 km from Laupstad via the lake at 289 and Morfjordskaret, with the treeline at 233 m and the steepest ground — 35.3 degrees between 763 and 786 m — in the summit cone.",
    },
  },
  litletind: {
    intro:
  ...
  skjomtinden: {
    intro:
      "1386 metres of ascent over 7.17 km from Nervatnet in Håkvikdalen to the Sleeping Queen — the profile everyone in Narvik knows from the Bjerkvik side, and one of the area's finest tours. Fri Flyt rates it KAST 2 – Challenging, but the gear list says ice axe and crampons, the west sides are at times bare and rocky, and the line gives back 33 vertical metres on the traverse — the card carries grade 4. The steepest hundred-metre band measures 20.3 degrees; the steepest sustained stretch, 33.7 degrees, sits in the gully between 1439 and 1462 m.",
    ascent: [
    ...
    elevationProfile: {
      ...
      endLabel: "1576 m",
      distanceLabel: "7.2 km",
      caption: "1386 metres of ascent and 7.17 km from Nervatnet via the ridge between Litletind and Dronninga and the traverse on the west sides, with the treeline at 546 m and the steepest ground — 33.7 degrees between 1439 and 1462 m — in the gully.",
    },
  },
  torskmannen: {
    intro:
  ...
  "varden-smaatindan": {
    ...
    elevationProfile: {
      ...
      caption: "763 metres of ascent and 4.82 km from Eidet by Kabelvåg — along Karlsvatnet on land, around Ørntindaksla, and the east flank to the cairn at 700.",
    },
  },
  himmeltindan: {
    intro:
  ...
  sandhornet: {
    ...
    descent: [
      ...
      "The source gives the north-east side its own access description and its own car park at Ravika, and says outright that you may choose to climb from that side. It is 1018 metres of ascent over 5.28 km: the forest road south-west along the west bank of Ravikelva, the bogs at Hornkroken at 252 m, point 385 and the easier ground south of point 580 — and at the end the one snowfield that reaches right up to the summit arête. The steepest step measures 36.1 degrees between 806 and 830 m against 32.5 on the route from Horsdal. The source states 40 degrees between 840 and 920 and adds crampons and an ice axe on hard surfaces, wind-loaded snow at the exit of the ramp and cornices along the arête.",
    ],
    avalanche: [
      {
        title: "Stjerndalen",
  ...
  middagstinden: {
    intro:
      "1291 metres of ascent over 6.04 km from Herdslan in Innfjorden to an alpine summit that is steep on every side — Fri Flyt rates the tour KAST 3 – Complex with a steepest point of 39 degrees, and the normal route feels airy and exposed. The line measures 25.1 degrees in its steepest 100 m band and 30.0 in its steepest sustained stretch, which is the last metres up the west-facing summit flank. The ridge to it is often wind-scoured: skis on the pack, and crampons and ice axe may be needed. This is the most serious tour of the round, and it says so itself.",
    ascent: [
    ...
    elevationProfile: {
      ...
      endLabel: "1568 m",
      distanceLabel: "6.0 km",
      caption: "1291 metres of ascent and 6.04 km from Herdslan around Berillvatnet and up the stream gully to the col at Tindevatnet, with the treeline at 740 m and the steepest ground — 30.0 degrees between 1549 and 1568 m — in the west-facing summit flank.",
    },
  },
  auskjeret: {
    intro:
  ...
  ytstevasshornet: {
    intro:
      "816 metres of climbing over 3.79 km from Svartevatnet, steeply up Vassdalen past the tarns at 976 m and then north-west onto a narrow summit ridge. The steepest sustained section measures 25.0 degrees, and the last stretch is usually walked without skis.",
    ascent: [
      ...
      "At the small mountain tarns — they lie at 976 m, the line passes them at 955 — it flattens out again: the band from 900 to 1000 m measures 10.8 degrees over 546 metres of ground. This is where you see the rest of the route, and it is also the natural place to turn back if the wind has built a cornice on the ridge above.",
    ...
    elevationProfile: {
      ...
      endLabel: "1331 m",
      distanceLabel: "3.8 km",
      caption: "816 metres of climbing and 3.79 km from Svartevatnet along the east shore and up Vassdalen past the tarns at 976 m, with the forest letting go at 691.",
    },
  },
  rana: {
    intro:
  ...
  jakta: {
    ...
    elevationProfile: {
      ...
      endLabel: "1589 m",
      distanceLabel: "4.8 km",
      caption: "1569 metres of climbing and 4.79 km from Norang, with the 33–36 degree flank from Konedalen up to the summit ridge as the crux.",
    },
  },
  skarasalen: {
    intro:
  ...
  hornindalsrokken: {
    intro:
      "1460 metres of climbing over 7.28 km from Langøylia, along a south ridge that rises and falls — 321 metres are given back on the way up. The last 103 are on a narrow, exposed rib where the steepest sustained section measures 40.5 degrees, and that is where most people take the skis off.",
    ascent: [
      ...
      "At about 1424 m you are on the east rib, and that is where most people take the skis off. The last 103 metres of climbing are narrow, exposed ridge: the band from 1400 to 1500 m averages 24.2 degrees, the steepest sustained section 40.5 degrees between 1482 and 1508 m, and the terrain model gives about 55 degrees straight east of the crest and 75 straight west.",
    ],
    descent: [
    ...
    avalanche: [
      {
        title: "The route",
        body: "A long ridge that rises and falls, and a traverse across the east flank above Kjellstaddalen. The band from 1400 to 1500 m averages 24.2 degrees, and the steepest sustained section measures 40.5 degrees between 1482 and 1508 m — that last one is the east rib, not the skin track.",
      },
      {
        title: "The terrain around it",
    ...
    elevationProfile: {
      ...
      endLabel: "1527 m",
      distanceLabel: "7.3 km",
      caption: "1460 metres of climbing and 7.28 km from Langøylia over Aksla, Trollaksla and Sætrenibba, with the east rib from 1424 m as the stretch most people walk.",
    },
  },
  sunndalsnipa: {
    intro:
  ...
  storronden: {
    intro:
      "1108 metres of climbing from Spranget, but the mountain only begins after six kilometres: the approach to Rondvassbu gains 132 metres, and the rest comes in 2.6 kilometres up the west ridge. Easier than Rondslottet from the same car park — no arête, no reclimbing.",
    ascent: [
    ...
    elevationProfile: {
      ...
      endLabel: "2139 m",
      distanceLabel: "10.2 km",
      caption: "1108 metres of climbing and 10.23 km from Spranget, 698 of those metres in the last 2.85 kilometres up the west ridge.",
    },
  },
  skala: {
    intro:
  ...
  lodalskapa: {
    ...
    elevationProfile: {
      ...
      caption: "1526 metres of climbing and 10.63 km from Bødalssætra over Sætrevatnet, Kåpevatnet and Bohrsbreen, with the steepest ground in the last hundred metres of climbing.",
    },
  },
  snonipa: {
    intro:
    ...
    descent: [
      ...
      "The usual mistake: choosing Veitebergsdalen for the way down because it looks shorter on the map. That is a different route from a different valley — you will find it as its own line on this map — and it does not end where the car is parked.",
      ...
      "Veitebergsdalen is now its own route on the map, not merely a descent variant. Fri Flyt's 4.8.2 starts at Veiteberg, at the forest road that runs up the valley — 290 m, exactly the start height the book gives — and follows the road to its end at 521, slanting up through the forest toward the moraine ridge Sollirinden, up the ridge to Sollibotnen at 894, around the glacier lake and up the icefall, and flat across the glacier east of the 1687 knoll to the top. 1673 metres of climbing over 9.27 km against 1494 over 8.45 km from Stardalen: the longer and the bigger of the two. The forest lets go at 781 m after 3.29 km. The steepest hundred-metre band is 20.3 degrees from 600 to 700 m. The steepest 30 m window, 30.3 degrees, runs downhill — from 1139 to 1113, where the line drops toward the outlet of the glacier lake at 1103 and has to climb back; that is also most of the 136 metres the route gives back. The source sanctions no crossing of the lake, so the line rounds it on the east side, on land.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  glittertinden: {
    ...
    descent: [
      ...
      "The other documented route comes from the far side of the mountain. From Spiterstulen it is 1390 metres of ascent over 10.24 km — three kilometres shorter than the normal route and 162 metres higher — north-east over Skautkampan at 1440 m, across Skauta at 1477 and along Steindalselve at 1547, all three in the place-name register and all three on the line. ut.no gives it 19.0 km there and back, 1378 metres of climbing and nine hours, season June to September. The steepest step measures 25.2 degrees between 1755 and 1771 m against the normal route's 18.5, and the steepest hundred-metre band 21.2 between 1900 and 2000. The hazard is the same from either side, and the source names it in three words: «occasionally overhanging summit cornice.»",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  steindalsnosi: {
    ...
    descent: [
      ...
      "The common mistake: letting yourself be drawn south off the summit, down Steindalen, without having planned for it. It is good skiing, and that line is on this map as its own route, but it is a different tour — 1025 metres down to Helgedalen, and your car is on Sognefjellsvegen. Hold the west ridge until you can see the lake.",
      ...
      "The south side is now its own route on the map, and it is not merely a variant: «Before the Sognefjell road opens it is best to climb the south side from Helgedalen», says the source in its own when-line. The normal route starts at Gjuvvatnet on Sognefjellsvegen, which is closed in winter — so until the road opens this is the way up. From Turtagrø at 884 m the line goes into Helgedalen past 910 and 1026, up toward Steindøla at 1202 and 1338, along the west side of the river at 1434 and 1520, into Steindalen at 1704, and over the entrance to the south side at 1893 to the western edge of the summit plateau at 1931 — the same point the normal route arrives at. 1172 metres of climbing over 7.83 km against 764 over 3.99 km from Gjuvvatnet: nearly twice the ascent and nearly twice the distance, because the tour starts 390 metres lower. The forest lets go at 1037 m after 3.92 km. The band from 1700 to 1800 m measures 21.3 degrees, the tour's steepest, and the steepest 30 m window is 28.4 between 1658 and 1675. The source warns about Steindøla: the river opens up some time in May.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  molden: {
    ...
    descent: [
      ...
      "From the quay at Marifjøra you get the whole mountain: 1131 metres of ascent over 5.28 km against the normal route's 626 over 3.31 km — Molden from the fjord instead of from Mollandsmarki at 501 m. The source's description is short and accurate: tractor road and gravel road, «after 1.5 km it climbs steeply through the forest to Steinkveane», on to the abandoned summer farm Svolsete at 724 m and then mountain ground with some steep pitches to the top. The steepest step sits exactly there, 36.3 degrees between 108 and 140 m, right above the road; higher up the steepest hundred-metre band measures 21.0 between 300 and 400. ut.no: 12.5 km, 1106 metres of climbing, five hours, June to October.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  gullfjellstoppen: {
    ...
    descent: [
      ...
      "Fri Flyt lists three starts for Gullfjellet, and the northern one has its own description: from the closed Gullbotn Turistheim at Trengereid, «follow the waymarks up into Gullbotn itself north of Mannaleitnipa (593 m) and on to Gullfjellshalsen». The waymarking is mapped the whole way. From the car park at 244 m the path leaves at 293, runs through Gullbotn itself at 447 north of Mannaleitnipa, over 699 and up onto Gullfjellhalsen — on the register as a ridge, 941 m — and from there the last metres to the cairn. 753 metres of climbing over 3.96 km against 839 over 7.80 km from Osavatnet: half the length, almost the same ascent, and no gravel road. It costs steepness. The band from 600 to 700 m measures 19.4 degrees against 8.1 in the steepest band on the western route, and the steepest 30 m window is 26.1 degrees between 607 and 629 against 27.4. It is not a single window that separates them — it is that the climbing here arrives in under half the distance. The forest lets go at 406 m after 1.4 km. This line gives back only 10 metres, against 159 on the western one.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  grafjell: {
    ...
    ascent: [
      ...
      "The track continues north until it splits at around 1282 m, and the branch turning east climbs Gråfjell. The band from 1300 to 1400 m is the steepest, 10.0 degrees over 585 metres of ground, and the last band, above 1400 m, measures 6.4 degrees. The cairn stands at 1466 m, 4.5 km north-west of Høgevarde. For the last three hundred metres below the top, from 1328 to 1378 m, the line runs up to 292 metres from the mapped track.",
    ],
    descent: [
  ...
  hogevarde: {
    ...
    descent: [
      "Back down the same way, south-west. That is the gentle side of the mountain, and the measurements say how gentle: 7.1 degrees on average to the west and 8.6 to the south-west over 500 metres, with steepest 60-metre windows of 25.6 and 23.8 degrees. The other documented route, the high-mountain track from Norefjellstua over Norefjellsryggen, gives 826 metres of climbing over 11.67 km and is a different day. It follows the mapped network at both ends but goes its own way in three places — at worst 427 metres from the nearest mapped track at 1119 m, and 317 and 364 metres off along Norefjellsryggen at 1315 and 1340 m.",
