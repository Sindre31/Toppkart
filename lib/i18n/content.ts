...
export const GUIDE_EN: Record<string, GuideTextEn> = {
  ...
  kjolen: {
    ...
    ascent: [
      "Start south of Finnvikvatnet, 224 m, which is where ut.no started: «we parked on the south side of Finvikvatnet, one of many starting points.» The mapped car park is 640 metres further north at the east end of the lake, and you can walk from there — but not across the ice: the water surface is 229 m and the land east of it 254 to 265, so the way is round rather than over. Fri Flyt describes four starting points for this mountain; this is the shortest.",
      ...
      "The only place the line really stands up is between 605 and 620 m, where the steepest 30-metre window measures 24.9 degrees. Fri Flyt gives a steepest point under 27 degrees for all four of its routes on the mountain. The summit plateau is reached at 774 m, and from there it is flat across to the big radar and the warming hut Troms Turlag built by volunteer work in 2010.",
    ],
    descent: [
      "Back the same way, east down Finnvikdalen. East measures 9.8 degrees on average out to a kilometre with a steepest 60-metre window of 18.4, and that is the whole story of that side.",
    ...
    avalanche: [
      ...
      },
      {
        ...
        body: "Seven of the eight directions from the summit measure under 12 degrees mean: north-east 10.0, east 9.8, south-east 9.9, south 11.3, south-west 7.9, west 4.8 and north-west 8.0. North measures 20.9 with 36.7 degrees in the window 710 to 770 metres out. That is the one edge worth knowing about, and it is easiest to find in poor visibility, when the plateau gives you nothing to navigate by and the radar disappears behind you.",
      },
      {
        title: "Before you go",
  ...
  rodtinden: {
    ...
    ascent: [
      ...
      "The first 942 metres follow the lit trail up Storelvdalen and climb 5.1 degrees on average. At 96 m the route leaves the trail for the hillside, and from there the gradient is strikingly even: 14.5 degrees from 100 to 200 m, 15.0 from 200 to 300, 15.1 from 300 to 400 and 14.9 above that. The tour gives back not one metre of height on the way up.",
    ...
    descent: [
      ...
      "The one steep thing on this mountain is south-east of the cairn, and it is close. The 135 radial measures 36.3 degrees 25 metres out, 39.3 at 40, 50.4 at 55 and 45.9 at 60, and does not drop below 25 degrees until 75 metres out; over a 60-metre window it is 33.1 degrees between 15 and 75 metres. Fri Flyt's «slopes of up to 40 degrees» is right, and slightly conservative.",
    ...
    avalanche: [
      ...
      },
      {
        ...
        body: "That slope is the tour's only hazard, and it is steeper than the figure Fri Flyt gives: 39.3 degrees 40 metres from the cairn, 50.4 at 55 and 45.9 at 60, with 33.1 degrees over a 60-metre window from 15 to 75 metres out. From the top it looks like the natural line back down to the stadium, and it is the shortest way home. The east side is the same story on a smaller scale: 15.0 degrees mean with a 29.4-degree window 20 to 80 metres out.",
      },
      {
        title: "Before you go",
  ...
  kavringtinden: {
    ...
    descent: [
      ...
      "If you would rather stay out of the gully, ski the northeast ridge you came up. It is steepest between 900 and 800 m, 24.9 degrees on average, and is often wind-scoured; expect hard snow where the ridge is narrowest.",
    ],
    avalanche: [
      {
        title: "The route",
        body: "The northeast ridge is the gentlest of the documented line choices on the mountain, but it is not flat. The east side below the crest runs past 30 degrees in places between 900 and 950 m, the steepest hundred metres on the line itself lies between 800 and 900 m at 24.9 degrees on average, and the steepest step measures 30.3. The ridge is often wind-scoured the whole way up — that means hard snow on the crest and wind slab in the lee slopes right beside it.",
      },
      {
        title: "The terrain off it",
    ...
    elevationProfile: {
      ...
      endLabel: "1289 m",
      distanceLabel: "5.6 km",
      caption: "1252 metres from Eidebakken to the cairn; the steepest hundred lies between 800 and 900 m, at 24.9 degrees on average.",
    },
  },
  "hesten-segla": {
    intro:
  ...
  breitinden: {
    intro:
      "Senja's highest peak, 1031 metres of climbing from the lay-by at the fjord. The ski tour ends at the shoulder at 763 m; the last 244 metres are exposed scrambling on the south-west ridge, and that finish is what makes this a grade 4.",
    ascent: [
      ...
      "From the north-east side of Breitindvatnet at 481 m the west flank begins. Low down it is gentle — about 24 degrees to 550 m and 29 on to 620 — but above that it steepens: a median 36 degrees between 620 and 680 m, 41 between 680 and 720, and directly below the shoulder the fall line measures 50 to 59 degrees. The summer description calls this same ground narrow, exposed rock ledges, and the lake sits below the whole slope. The steepest hundred-metre band on the route lies between 600 and 700 m and averages 23.4 degrees; the steepest sustained section on the line is 39.4 degrees, and it is in the summit block.",
  ...
  strandtinden: {
    intro:
      "1090 metres of climbing and 4.77 km from the E10 at sea level to the summit at 1076 m — the great classic of the Harstad area, and a mountain with no gentle side. The steepest hundred-metre band on the route is 19.0 degrees between 600 and 700 m and the steepest step 28.7 between 670 and 690, but the flanks around it measure 54 to 64 degrees in their steepest windows. The route takes the summit from the west because west is the one edge that does not.",
    ascent: [
      ...
      "The normal route follows Heggedalen on the ridge between the two rivers. At around 146 m it crosses to the north side of the river, and the two spot heights the description navigates by turn up where they should: the gully at «height 505» measures 509.6 m, and «height 570» measures 570.3 — 234 metres apart. The first hundred metres of climbing are the steepest in the valley floor at 13.9 degrees, and then it eases to 8.5 and 9.7. Kartverket puts the last forest at 208 m, a kilometre along the line.",
      "From 570 the route swings south and holds the east side of the bowl. The steepest band of the tour is here — 19.0 degrees from 600 to 700 m over 308 metres of ground — and the steepest step, 28.7 degrees between 670 and 690. The bowl flattens at 805 m, and from there the route holds west and takes the summit by the west ridge past 901. The last sample point below the top, at 1023 m, answers the terrain class SnøIsbre — the snow on this side lies year round, and it is the same side Fri Flyt says holds snow well into June. Fri Flyt: «the easiest way to the top is to keep right (west) from here and climb the summit by the ridge from the right (west).»",
    ],
    descent: [
      "Down the north side, the way you came. It is the line the mountain is known for: «the descent is the same route as the ascent, and it is the classic — you can let them run and get real flow and a broad grin.» From sea level that means 1090 metres of continuous descent in season — Fri Flyt writes that «in season you ski all the way down to the road by the sea», and that the snow on the north side lies late enough that a midnight-sun tour in June is not unusual.",
      "But the north side is not gentle, and it is worth knowing how steep it is where you are standing. Directly north of the cairn the flank measures 41.8 degrees in its steepest 60-metre window only 20 to 80 metres out, with 24.8 degrees mean out to a kilometre. The route avoids it by climbing and descending by the west ridge, which measures 17.0 degrees mean and is the gentlest of all eight directions.",
      "The other three edges are serious. South measures 30.6 degrees mean with 64.3 degrees in the window 10 to 70 metres from the cairn, south-east 30.9 with 62.5, east 29.0 with 54.9 only 20 to 80 metres out, and south-west 24.1 with 56.0. Fri Flyt describes two descents in that terrain — Kvanntoa to the north-east and Kvannto to the east — with sections at 45 degrees and a rappel anchor, and they are not the route this card describes.",
    ],
    avalanche: [
      {
        title: "The bowl",
        body: "Fri Flyt gives one hazard on the normal route, and it is unambiguous: «large avalanches have run in the bowl several times, so pick days with stable snow.» The bowl is the hollow the route crosses between height 570 and 805 m, and it holds the steepest band of the tour — 19.0 degrees from 600 to 700 m. The description sends you along its east side, not through the middle.",
      },
      {
        title: "The mountain has no gentle side",
        body: "None of the eight directions from the summit measures under 17.0 degrees mean out to a kilometre, and four of them carry 60-metre windows over 50 degrees: south 64.3, south-east 62.5, south-west 56.0 and east 54.9. Even the north side the route uses measures 41.8 degrees in the window 20 to 80 metres below the cairn. Fri Flyt files the tour as KAST 3 – complex and lists an ice axe and crampons as extra equipment: «crampons and an axe can be worth having on days with a hard crust.»",
      },
      {
        title: "Before you go",
    ...
    elevationProfile: {
      ...
      caption: "1090 metres of climbing and 4.77 km from the E10 at 21 m up through Heggedalen past 146, the gully at 510 and spot height 570, and across the bowl to 805 and the west ridge at 901.",
    },
  },
  rombakstotta: {
    intro:
    ...
    avalanche: [
      {
        title: "The route",
        body: "The line as drawn stays under 30 degrees the whole way. The steepest hundred metres sit between 500 and 600 m at a mean of 18.8 degrees, and the steepest single step measures 26.3 degrees. The bench north of Isvatnet runs at four to twenty-four degrees. The summit block is the exception — that is climbing, not ski terrain.",
      },
      {
        title: "The terrain around it",
  ...
  geitgaljen: {
    intro:
      "1071 metres of climbing from the fjord in 3.82 km, and the entire line lies in avalanche terrain. Topptursentralen grades the tour KAST 4 — extreme — and the top 157 metres average 42 degrees and require crampons and an axe.",
    ascent: [
  ...
  vassfjellet: {
    intro:
      "541 metres of climbing and 4.74 km from Markavollen to the cairn at 711 m — the closest ski tour to Trondheim. Almost all the steep ground sits in one band: 15.9 degrees from 500 to 600 m, over just 405 metres of ground. The steepest sustained step is 23.0 degrees between 251 and 270 m, and that is also the steepest the whole line measures.",
    ascent: [
  ...
  krakfjellet: {
    intro:
      "471 metres of climbing and 9.60 km from Håen to the highest point in Trondheim municipality. It is a long, gentle day: the band from 400 to 500 m measures 1.2 degrees over 4505 metres of ground, and the steepest place on the whole line is 13.9 degrees between 659 and 670 m.",
    ascent: [
  ...
  storbekkhoa: {
    intro:
      "897 metres of climbing and 5.92 km from Storli to the cairn at 1504 m. The ascent is gentle — the steepest hundred-metre band is 17.5 degrees — and the south-east face right by the top is not: it measures 34.1 degrees on average with a 46.9-degree window 20 to 80 metres out from the cairn.",
    ascent: [
      "Start at the car park by Storli, 623 m — pay and display, 30 kroner in the box, and tagged for skiing. Ut.no: «From Storli parking you put your skis on at the car.» Head straight north toward Storbekkdalen through the birch slope. Here the sources part company: ut.no puts the route on the right-hand side of Veslebekken, while Fri Flyt writes that it follows Storbekken north from Storli through the birch forest. The line follows the mapped path, which does a little of both — it crosses Veslebekken down in the birch slope and stays 7 to 967 metres from Storbekken on the way up the valley. The band from 700 to 800 m is the steepest below the treeline, 15.8 degrees over 360 metres of ground.",
    ...
    avalanche: [
      {
        title: "The route",
        body: "897 metres of climbing where the steepest hundred-metre band is 17.5 degrees — and there are two of them, from 700 to 800 m and from 1300 to 1400 — and the steepest sustained step 26.4 degrees between 1082 and 1099. Fri Flyt writes that the whole ascent is in terrain under 30 degrees and files the tour as KAST 1. The route gives back 16 metres over 5.92 km.",
      },
      {
        title: "The terrain off it",
  ...
  jonshornet: {
    ...
    avalanche: [
      {
        title: "The route",
        body: "An even climb to Rametinden and seriousness above the col. The steepest sustained section measures 32.2 degrees between 1165 and 1187 m, and the band from 1200 to 1300 m runs at 18.4. The flanks off the ridge between Rametinden and the summit are avalanche terrain.",
      },
      {
        title: "The terrain around it",
  ...
  rana: {
    intro:
      "1602 metres of climbing from 63 m — fjord to summit over 8.61 km, under one of the oldest names in the Sunnmøre Alps. The steepest sustained section measures 37.5 degrees and sits right up on the summit crest, between 1530 and 1555 m.",
    ascent: [
      ...
      "Follow the road up through the forest — Kartverket has forest to 231 m — past Haukåssætra and into the valley toward Nordkopen at 501 m. The band from 400 to 500 m measures 17.3 degrees, and otherwise the whole approach is gentle: 5.8 degrees from 100 to 200 m and 6.6 from 200 to 300.",
    ...
    avalanche: [
      {
        title: "The route",
        body: "A gentle approach and a steep middle: the band from 1000 to 1100 m averages 21.0 degrees, and the flank up from Nordkopen to the arête is avalanche terrain. The summit crest itself is the steepest part at 37.5 degrees over thirty metres between 1530 and 1555 m, and it is also where the cornices sit.",
      },
      {
        title: "The terrain around it",
  ...
  slogen: {
    intro:
      "The queen of the Sunnmøre Alps, and one of the most serious tours in the region. 1520 vertical metres from Norangsdalen to a summit most people walk the last 350 metres to.",
    ascent: [
  ...
  skarene: {
    intro:
      "1219 metres of climbing over 6.44 km from Korsmyra, with two kilometres of flat valley floor before the big snow flank begins. The flank holds 18 to 21 degrees band after band from 900 to 1700 m — and it is continuous avalanche terrain the whole way.",
    ascent: [
      ...
      "Coming in toward the head of the valley at 940 m the big snow flank begins, and it holds the same character all the way up: 18.1 degrees from 900 to 1000 m, 20.5 from 1000 to 1100, 20.0 from 1300 to 1400, 21.2 from 1500 to 1600 and 21.3 from 1600 to 1700 — the steepest hundred-metre band. The steepest sustained section measures 26.8 degrees between 1528 and 1544 m.",
    ...
    avalanche: [
      {
        title: "The route",
        body: "A continuous snow flank from 940 m to the summit, with bands between 18.1 and 21.3 degrees and a steepest sustained section of 26.8 degrees between 1528 and 1544 m. The angle is moderate; it is the size and the continuity that are the problem.",
      },
      {
        title: "The terrain around it",
  ...
  glitregga: {
    intro:
      "901 metres of climbing over 4.38 km from the sports ground in Randabygd, south-facing and even the whole way. The steepest sustained section on the line measures 21.4 degrees — a full day in vertical metres and an easy one in angle.",
    ascent: [
    ...
    avalanche: [
      {
        title: "The route",
        body: "Even and open: the steepest hundred-metre band, 900 to 1000 m, measures 18.4 degrees, and the steepest sustained section 21.4 degrees between 1044 and 1063 m. It is the length and the 901 metres of climbing that make this demanding, not the angle.",
      },
      {
        title: "The terrain around it",
  ...
  lodalskapa: {
    intro:
      "1526 metres of climbing over 10.62 km to the only 2000-metre peak in Nordfjord. Two thirds of the tour is a gentle approach; the rest is glacier with deep crevasses, and the steepest sustained section measures 35.6 degrees between 1975 and 2008 m.",
    ascent: [
      ...
      "On up toward the ridge and a traverse below Veslekåpa before the final stretch to the summit at 2082 m. The band from 1900 to 2000 m measures 19.8 degrees, and the steepest sustained section 35.6 degrees between 1975 and 2008. Glacier kit, crampons and an ice axe belong on this tour.",
    ],
    descent: [
    ...
    avalanche: [
      {
        title: "The route",
        body: "A long flat approach and a steep top: the steepest hundred-metre band, 1300 to 1400 m, measures 20.5 degrees, and the steepest sustained section 35.6 degrees between 1975 and 2008 m. Brattebakkane up to the glacier is avalanche terrain.",
      },
      {
        title: "The terrain around it",
  ...
  snonipa: {
    ...
    ascent: [
      ...
      "Up on the plateau you traverse north-west and come onto the summit from the north-west. The climbing is even: 15.9 degrees from 1200 to 1300 m, 19.2 from 1300 to 1400 — the steepest hundred-metre band — and 18.2 from 1700 to 1800, with the cairn at 1827 m. Around 1687 m the surface is often wind-scoured and hard.",
    ],
    descent: [
  ...
  glittertinden: {
    intro:
      "Norway's second highest summit, and a surprisingly gentle tour: the steepest sustained section on the whole line measures 19.6 degrees. What it costs you is distance — 13.32 km each way, seven of them pure approach up Veodalen — and the fact that the upper part lies on Glitterbrean.",
    ascent: [
  ...
  steindalsnosi: {
    ...
    elevationProfile: {
      ...
      caption: "764 metres of climbing over 4.0 kilometres from Gjuvvatnet, all above the treeline. Steepest section on the climb: 35 degrees between 1820 and 1860 m.",
    },
  },
  besshoe: {
    intro:
  ...
  kvamshesten: {
    ...
    ascent: [
      ...
      "From Rabbane it goes north toward the pass east of Skaravatnet at 715 m. The stretch between 700 and 800 m is the gentlest of the tour, 3.8 degrees over 1439 metres of ground. The route holds the north side of the lake westward and rounds Grunnevatnet at 785 m.",
  ...
  molden: {
    ...
    ascent: [
      ...
      "Follow the road and then the summer path up through the forest. The climbing is even and without surprises: 10.7 degrees from 500 to 600 m, 14.4 from 600 to 700 and 14.2 from 700 to 800. The steepest sustained section of the whole tour is down here, 23.3 degrees over thirty metres between 704 and 718 m.",
  ...
  nibbi: {
    ...
    ascent: [
      ...
      "Alongside the fall it climbs evenly: the band from 900 to 1000 m measures 12.9 degrees over 311 metres of ground, 1000 to 1100 measures 14.3 over 360, and 1100 to 1200 measures 18.6 over 315. The steepest step on the whole line is here, 24.2 degrees between 1249 and 1269 m. The forest lets go at 1054 m and the ground is open from 1066.",
  ...
  raskarfjellet: {
    ...
    descent: [
      ...
      "What is steep is a long way from the route. The north flank has a 60-metre window of 41.7 degrees, but that is 930 to 990 metres out — down where the mountain finally falls towards the valley. Closer to the cairn the steepest readings are 27.0 degrees to the east 60 to 120 metres out and 27.0 to the south 30 to 90 metres out.",
    ],
    avalanche: [
      {
        title: "The route",
  ...
  storanosi: {
    ...
    ascent: [
      ...
      "From Eggjane at 1179 m it is one and a half kilometres of plateau west to Storanosi, 1205 m. The band from 1100 to 1200 m measures 3.4 degrees over 1784 metres of ground — that is the part that makes this tour long rather than steep, and the line gives back 40 metres of height along the way.",
    ],
    descent: [
  ...
  ustetind: {
    ...
    avalanche: [
      {
        title: "The route",
        body: "416 metres of climbing where the steepest band is 9.7 degrees and the steepest step 20.5. The route gives back 29 metres over 4.38 km. Ut.no grades the tour moderate and child-friendly. The angle is not the problem here.",
      },
      {
  ...
  vesoldo: {
    ...
    ascent: [
      "From the car park at Byrkjenes, 211 m, at the far end of Tordalsvegen north of Strandebarm, climb the steep forested slope towards Fadnastølen, 498 m. This is the steepest part of the tour: the steepest hundred-metre band lies between 300 and 400 m and averages 16.7 degrees. Tordalsvegen is a private toll road, and ploughing all the way to the car park is not guaranteed — check before you drive far.",
    ...
    elevationProfile: {
      ...
      endLabel: "1046 m",
      distanceLabel: "4.2 km",
      caption: "838 metres of climbing and 4.25 km from Byrkjenes, with the steepest ground — 16.7 degrees between 300 and 400 m — down in the forest.",
    },
  },
  ranten: {
    intro:
      "532 metres of climbing over 5.82 km from Tempelseter to the jagged ridge Th. Kittelsen painted as Soria Moria. The climb from Raudmyra is gentle — the steepest sustained section measures 27.1 degrees — and the south side looks gentle for the first hundred metres from the cairn. Then it breaks off at 47 to 60 degrees, and that is the way the marked path goes down.",
    ascent: [
    ...
    avalanche: [
      {
        title: "The route",
        body: "The climb from Raudmyra is an even slope: 13.9 degrees on average from 1300 to 1400 m, and a steepest sustained section of 27.1 degrees between 1322 and 1338 m. The first four kilometres from Tempelseter stay below 6 degrees. The route itself is not the problem on this mountain.",
      },
      {
        title: "The terrain around it",
