...
Derfrå følgjer du toppryggen nordover. Han er brei og slakar av mot 1400 moh — 6,9 grader frå 1300 til 1400 — før den siste stigninga langs kammen frå 1531 og 1562 moh til varden på 1587. Det er her det brattaste ligg: 37,5 grader over tretti meter mellom 1530 og 1555 moh.',
  description_down = 'Ned same vegen: kammen, den breie toppryggen, ned egga til Nordkopen og ut dalen til Urkegjerdet. Fallretninga er søraust, og nedkøyringa er lang — 1595 høgdemeter i eitt strekk frå toppen til fjorden.
...
update public.tk_tours set
  description_up   = 'Start på den store parkeringsplassen ved Helgatun på Krøvelseidet, 252 moh, på vegen mellom Volda og Ørsta. Løypa tek av frå plassen og går rett inn i skogen. Ho er tidvis preparert med trakkemaskin, og den siste bakken er merkt med brøytestikker.
...
Over bakken flatar det brelagde platået ut: 10,2 grader frå 1200 til 1300 moh og 5,6 frå 1500 til 1600 over 1036 meter grunn. Du følgjer det til høgda på 1583 moh, går ned eit lite skar og nordover langs ryggen til toppen på 1700 moh. Den publiserte høgda 1717 er snøkuppelen; terrengmodellen les fjellet til 1700.',
  description_down = 'Ned same vegen: sørover langs ryggen, over platået og ned Brattbakken til Snødalen. Fallretninga er aust, og Brattbakken er den delen av nedkøyringa som avgjer om dagen er ein skitur eller ei øving i kantsikring.
...
Ryggen er jamn heile vegen opp: 13,6 grader frå 900 til 1000 moh, 15,4 frå 1000 til 1100 og 15,9 frå 1100 til 1200. Over 1400 moh flatar han ut mot varden på 1567 — bandet frå 1400 til 1500 moh måler 8,3 grader over 675 meter grunn.',
  description_down = 'Ned same ryggen, austover mot Remestøylen og Dragesetvegen. Ryggen er brei og oversiktleg, og fallretninga er vest.
...
update public.tk_tours set
  description_up   = 'Start ved vegenden på Rytnavegen, 404 moh — den private vegen som er skilta mot parkering til Storehesten. Fri Flyt oppgjev to vertikalar for dette fjellet, og dei er to ulike startar: 960 høgdemeter frå Rytnane nede på 209 moh, og 810 herifrå.
...
update public.tk_tours set
  description_up   = 'Fra Hornslie, der Torsetstølvegen ender på 1056 moh, går du rett opp den første bakken. Den er kortere enn den ser ut — den første hundremeteren, 1000–1100 moh, ligger på 18,8° i snitt — og over kanten flater det ut. Her er ingen skog å forholde seg til: hele turen går i åpent terreng.
...
update public.tk_tours set
  description_up   = 'Start bak Tempelsetra kafè, 910 moh, og følg løypa mot Istjenn. Skogen slipper taket allerede ved 937 moh, og på 950 moh går ruta ut på Istjenn — Kartverket klasser punktet som innsjø, og det er første av tre vann turen krysser eller følger på is.
...
Løypa fortsetter nordover til den deler seg rundt 1282 moh, og grenen som dreier østover går opp på Gråfjell. Bandet fra 1300 til 1400 moh er det bratteste, 10,0 grader over 596 meter grunn, og det siste bandet, over 1400 moh, måler 6,4 grader. Varden står på 1466 moh, 4,5 km nordvest for Høgevarde.',
  description_down = 'Ned samme vegen, sørvestover og så sørover langs løypa. Toppen er rund og flat, og det er verdt å vite hvor rund: radialmålinger fra varden gir 5,2 til 18,3 grader i snitt over 500 meter i alle åtte retninger, og det bratteste 60-metersvinduet på hele fjellet måler 30,2 grader.
...
DNT-hytta Høgevarde ligger på 1397 moh, og toppen 560 meter lenger nordøst, på 1461. Det siste bandet, over 1400 moh, måler 3,5 grader over 810 meter grunn — flatt, og samtidig den mest værutsatte delen av turen. Gamle Høgevarde turisthytte har kafé i vinterferiene og påsken, og skilt nederst i bakken sier om hun er åpen.',
  description_down = 'Ned samme vegen, sørvestover. Det er den slake sida av fjellet, og målingene sier hvor slak: 7,1 grader i snitt mot vest og 8,6 mot sørvest over 500 meter, med bratteste 60-metersvindu på 25,6 og 23,8 grader.
...
Det siste bandet, 800 til 900 moh, er det bratteste: 15,1 grader over bare 244 meter grunn. Ut.no kaller oppstigningen «temmelig bratt» og anbefaler å sette igjen sekken i stikrysset. Varden står på 871 moh, og Styggemannshytta ligger rett ved.',
  description_down = 'Ned samme vegen, sørover og så vestover langs løypa. Sørsida er den slake av de bratte: 29,8 grader i bratteste 60-metersvindu på peiling 190 og 34,4 grader på 200, 140 til 220 meter under toppen. Sørmyrseter ligger på peiling 191 fra varden, så den beskrevne linja er også den mildeste.
