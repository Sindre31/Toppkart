...
values
  ...
  ('rornestinden',    'Rørnestinden',    'Lyngen',     69.57329, 20.11187, 1041, 1041, '4–6 t', 2, 'V',  'jan–mai', 'Den vennligste inngangen til Lyngsalpene, med slak rygg og romslig nedkjøring.', true),
  ('kavringtinden',   'Kavringtinden',   'Lyngen',     69.54704, 20.12428, 1289, 1150, '5–7 t', 3, 'N',  'mar–mai', 'Indre Lyngen-perle med nordvendt snø som holder seg langt ut i mai.', true),
  ('hesten-segla',    'Hesten (Segla)',  'Senja',      69.51388, 17.58462,  626,  620, '2–4 t', 2, 'S',  'jan–apr', 'Kort tur, stort postkort: nedkjøring med Segla i fanget og havet under.', true),
  ...
  ('stornappstinden', 'Stornappstinden', 'Lofoten',    68.1441, 13.41493,  740,  730, '3–5 t', 2, 'N',  'jan–apr', 'Lofot-klassiker i overkommelig format — mye fjell for høydemeterne.', true),
  ('kirketaket',      'Kirketaket',      'Romsdal',    62.61158,  7.90672, 1439, 1380, '5–6 t', 2, 'SV', 'des–mai', 'Norges kanskje mest populære topptur: bred rygg, trygge linjevalg, lang sesong.', true),
  ('slogen',          'Slogen',          'Sunnmøre',   62.20818,  6.67306, 1564, 1560, '6–8 t', 4, 'V',  'mar–mai', 'Sunnmørsalpenes dronning — en alvorlig tur for erfarne, i riktig vindu.', true),
  ('kolastinden',     'Kolåstinden',     'Sunnmøre',   62.25886,  6.31102, 1432, 1150, '5–7 t', 3, 'N',  'feb–mai', 'Alpin klassiker fra Standaldalen med velkjent renne og storslått finish.', true),
  ...
  ('fanaraken',       'Fanaråken',       'Sogn',       61.51669,  7.90825, 2068,  950, '5–7 t', 2, 'N',  'apr–jun', 'Høyfjellstur fra Sognefjellet med breutsikt og pålitelig vårsnø.', true),
  ('steindalsnosi',   'Steindalsnosi',   'Sogn',       61.52696,  7.90076, 2025,  620, '3–5 t', 1, 'S',  'apr–jun', '2000-meter for de fleste: kort, slak og solvendt fra Sognefjellsveien.', true),
  ('galdhopiggen',    'Galdhøpiggen',    'Jotunheimen',61.63644,  8.31243, 2469, 1100, '6–8 t', 3, 'N',  'apr–jun', 'Norges tak på ski — bre, tau og stor høyde; vanligvis gått fra Juvasshytta.', true),
  ...
  ('bitihorn',        'Bitihorn',        'Valdres',    61.29435,  8.79947, 1607,  500, '2–4 t', 1, 'S',  'feb–mai', 'Markert horn med enkel normalrute og fin utsikt over Bygdin.', true),
  ('rondslottet',     'Rondslottet',     'Rondane',    61.9149,  9.8512, 2178, 1050, '6–8 t', 2, 'S',  'mar–mai', 'Rondanes høyeste: rolig høyfjellsterreng og stabil vårsesong.', true),
  ...
  ('storehorn',       'Storehorn',       'Hemsedal',   60.81506,  8.59566, 1478,  630, '3–4 t', 2, 'Ø',  'des–apr', 'Hemsedals husfjell for topptur — kort vei fra bilen, mange linjevalg.', true),
  ('oksen',           'Oksen',           'Hardanger',  60.45983,  6.68301, 1241, 1240, '4–6 t', 2, 'SV', 'jan–apr', 'Fjordutsikt i alle retninger og jevn stigning fra Tjoflot.', true),
  ('melderskin',      'Melderskin',      'Hardanger',  60.00623,  6.08261, 1426, 1420, '6–8 t', 3, 'V',  'feb–mai', 'Rosendalsalpenes storslåtte klassiker, fra sjøen til 1426 moh.', true),
