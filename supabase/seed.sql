...
values
  ...
  ('moysalen', 'Møysalen', 'Vesterålen', 68.52598, 15.45215, 1264, 1600, '7–9 t', 4, 'SØ', 'jan–mai', '1600 høydemeter fra E10 ved Litlvatnet: 355 av dem gir du fra deg underveis, 123 av dem ned til Grønnvatnet på 328.', true),
  ...
  ('kjerag', 'Kjerag', 'Rogaland', 59.01672, 6.58762, 1124, 620, '4–6 t', 2, 'Ø', 'mai–juni', '620 høgdemeter frå Øygardstøl om Langavassvegen og Kjeragplatået; slakt heile vegen, men Lysevegen opnar først i mai.', true)
;
...
Fra breen på rundt 1025 moh går ruta nordvest opp toppryggen. Ryggen er ikke jevn. 9332 meter ute stiger linja til 1170 moh og faller så 51 meter til 1119 over 27,3 meter grunn — et hakk, ikke en målefeil: tolv DTM1-punkt med 2,3 meters mellomrom gjennom fallet gir en sammenhengende kurve fra 1170,0 til 1119,2, og et rutenett på 40 meter til hver side gir fra 1186 til 1055 moh, så nabolinjene er ikke slakere. Det er dette som gjør at største steg langs ruta måler 45,9 grader, og det er her isøksa og stegjerna hører hjemme. De siste 500 metrene går på peiling 333 grader og stiger 124 meter; det bratteste 200-metersvinduet på turen, 24,3 grader fra 1189 til 1264 moh, er selve toppryggen.',
  description_down = 'Ned samme vei. Fallvekta gjennomsnittsretning er 193 grader — sør — men det tallet er dominert av de lange kilometrene nede i dalen. Selve toppryggen og breen under den ligger sørøst, og det er den delen Friflyt beskriver som god nedkjøring. Over hakket i ryggen går de fleste til fots.
...
Etter knapt tre kilometer kommer du til Kråklivollen, 452 moh, der vegen slutter og ruta går opp i skogen, opp Kråklia og vest for Samsjølia. Skogen slipper taket på 524 moh, og fra 529 er du i åpent terreng. Bandet fra 400 til 500 moh måler 1,2 grader over 4505 meter grunn — det er avstanden, ikke stigninga, som er turen her.
...
update public.tk_tours set
  description_up   = 'Start ved vestenden av hyttevegen i Langøylia, 388 moh, mellom Hellesylt og Hornindal. Gå opp lia gjennom open lauvskog, aust for Gjøelva; skogen held til 521 moh, og bandet frå 600 til 700 moh måler 18,9 grader.
...
update public.tk_tours set
  description_up   = 'Start ved vegen ved Myrdalsvatnet, 367 moh, i Uskedalen. Følg vegen litt tilbake til ein traktorveg og følg denne til Nipelva kjem til syne. Skogen held til 531 moh.
