...
Videre langs ryggen til toppen på 938 moh. De øverste hundre høydemeterne er ofte vindherjet og harde. Hold deg på sørsida av ryggen — nordsida faller 60 grader rett under egget, og det er der skavlene henger.',
  description_down = 'Ned samme vei: sørover langs ryggen, ned henget til skåla, og ut fjellsida mot Keipelva og parkeringa. Henget fra ryggen til skåla er den beste kjøringen og det brattaste du er innom — 32 til 33 grader, og en skål under deg som samler alt som løsner.
