...
values
  ...
  ('saudehornet', 'Saudehornet', 'Sunnmøre', 62.23578, 6.14246, 1303, 1150, '4–6 t', 3, 'SV', 'jan–mai', '1154 høgdemeter frå vassverket i Ørsta, og sørryggen held 33–39° dei siste 170.', true),
  ...
  ('skarasalen', 'Skårasalen', 'Sunnmøre', 62.16566, 6.48583, 1542, 1430, '6–8 t', 3, 'V', 'jan–mai', '1438 høgdemeter frå bommen på Kvistadvegen, med det brattaste opp mot skaret på 1074 moh.', true),
  ...
  ('storronden', 'Storronden', 'Rondane', 61.8917, 9.86198, 2139, 1090, '6–8 t', 2, 'SV', 'mars–mai', '1057 høydemeter fra Spranget: seks kilometer innmarsj til Rondvassbu, så 2,6 km jevn vestrygg fra stidelet på 1440 moh.', true),
  ...
  ('glittertinden', 'Glittertinden', 'Jotunheimen', 61.65138, 8.5575, 2451, 1170, '7–9 t', 3, 'SØ', 'juni–juli', '12,6 km og 1154 høydemeter fra Veodalen: 7 km flat innmarsj til Glitterheim, så jevn stigning øst for Glitterbrean.', true),
  ...
  ('rasletinden', 'Rasletinden', 'Jotunheimen', 61.39514, 8.69944, 2104, 740, '4–6 t', 2, 'Ø', 'apr–mai', '713 høydemeter og 6 km fra Valdresflye: flatt de første 1,2 km, så en kneik til 1530 moh og slak rygg østfra mot toppen.', true),
  ...
  ('skogshorn', 'Skogshorn', 'Hemsedal', 60.88148, 8.69482, 1729, 830, '3–5 t', 2, 'Ø', 'feb–mai', '836 høgdemeter frå Trefta opp den breie austryggen; brattaste måling er 28,5 grader.', true),
  ...
  ('lonahorgi', 'Lønahorgi', 'Voss', 60.69383, 6.41489, 1412, 1300, '5–7 t', 2, 'NØ', 'feb–april', '1273 høgdemeter frå Høyland via Bergsstølen og Breiming, med dei siste 107 opp nordryggen frå punkt 1305.', true),
  ('folarskardnuten', 'Folarskardnuten', 'Hallingdal', 60.61336, 7.79146, 1927, 940, '6–8 t', 3, 'S', 'mars–mai', 'Nær 12 km inn frå Haugastøl og 920 høgdemeter, med eit kort 37-graders trinn opp frå Folarskardet.', true),
  ...
  ('vesoldo', 'Vesoldo', 'Hardanger', 60.31237, 6.09197, 1046, 830, '3–5 t', 2, 'SV', 'feb–apr', '834 høgdemeter frå Byrkjenes, skog opp til Fadnastølen og open sørvestrygg over; nord- og vestsida av toppen fell 48–55°.', true),
...
update public.tk_tours set
  description_up   = 'Fra parkeringen ved Eidebakken, 63 moh, følger du skogsveien opp østsida av Gjerdelva. Du passerer Rødsteinen i bjørkeskogen rundt 200 moh og fortsetter opp ryggen øst for elva. Ruta krysser aldri Gjerdelva — går du over vann, har du gått feil.
...
Toppen er et platå på 2025 moh. Varden ligger helt på kanten av nordsida — gå fram til den, ikke forbi den. Skavlene bygger seg ut mot nord og øst. Rett under varden stuper nordsida: de første 120 høydemetrene faller på nær 60 grader. Så slakner den til en hylle rundt 1840 moh, før den setter utfor igjen — 42 til 45 grader fra 1620 til 1500 moh, med bre og klipper under det.',
  description_down = 'Ned går du samme veg, vestover. Den store skålforma under ryggen er det morsomste på turen: 25 til 30 grader jevnt, korte partier over 30, og ett steg på 36 grader mellom 1880 og 1860 moh. Derfra er det slakt ned dalsøkket til Gjuvvatnet.
...
update public.tk_tours set
  description_up   = 'Fra Hornslie, der Torsetstølvegen ender på 1056 moh, går du rett opp den første bakken. Den er kortere enn den ser ut — det bratteste hundremeterspennet på hele ruta, 1000–1100 moh, ligger på 18,8° i snitt — og over kanten flater det ut. Her er ingen skog å forholde seg til: hele turen går i åpent terreng.
...
update public.tk_tours set
  description_up   = 'Fra avgiftsparkeringen øverst på Tjoflotvegen, 277 moh, følger du traktorveien et kort stykke før stien tar over. Regn med å bære ski gjennom skogen: skoggrensa ligger på 538 moh, og de fleste spenner dem først på oppe ved Vindhovden.
...
update public.tk_tours set
  description_up   = 'Fra parkeringen ved Kletta, 153 moh, følger du veien 300 meter før stien svinger opp mot Skarshaug. Første strekket går over innmark og videre inn i blandingsskogen; sporet er tydelig, og du stiger jevnt gjennom skogen til rundt 520 moh.
